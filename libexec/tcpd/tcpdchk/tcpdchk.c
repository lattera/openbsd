/*	$OpenBSD: src/libexec/tcpd/tcpdchk/tcpdchk.c,v 1.8 2003/06/26 07:53:27 deraadt Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/libexec/tcpd/tcpdchk/tcpdchk.c,v 1.8 2003/06/26 07:53:27 deraadt Exp $";
#endif
#endif

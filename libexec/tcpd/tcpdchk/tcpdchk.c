/*	$OpenBSD: src/libexec/tcpd/tcpdchk/tcpdchk.c,v 1.9 2006/12/20 01:50:30 ray Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/libexec/tcpd/tcpdchk/tcpdchk.c,v 1.9 2006/12/20 01:50:30 ray Exp $";
#endif
#endif

/*	$OpenBSD: src/libexec/tcpd/tcpdchk/tcpdchk.c,v 1.7 2002/07/30 22:27:20 deraadt Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/libexec/tcpd/tcpdchk/tcpdchk.c,v 1.7 2002/07/30 22:27:20 deraadt Exp $";
#endif
#endif

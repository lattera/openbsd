/*	$OpenBSD: src/libexec/tcpd/tcpdchk/scaffold.c,v 1.5 2002/05/07 23:01:07 deraadt Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/libexec/tcpd/tcpdchk/scaffold.c,v 1.5 2002/05/07 23:01:07 deraadt Exp $";
#endif
#endif

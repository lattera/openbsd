/*	$OpenBSD: src/libexec/tcpd/tcpdchk/scaffold.c,v 1.4 2000/10/14 00:56:14 itojun Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/libexec/tcpd/tcpdchk/scaffold.c,v 1.4 2000/10/14 00:56:14 itojun Exp $";
#endif
#endif

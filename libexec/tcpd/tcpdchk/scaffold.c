/*	$OpenBSD: src/libexec/tcpd/tcpdchk/scaffold.c,v 1.2 1999/06/06 15:34:57 deraadt Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/libexec/tcpd/tcpdchk/scaffold.c,v 1.2 1999/06/06 15:34:57 deraadt Exp $";
#endif
#endif

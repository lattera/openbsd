/*	$OpenBSD: src/libexec/tcpd/tcpdchk/inetcf.c,v 1.3 2003/04/07 22:56:19 deraadt Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/libexec/tcpd/tcpdchk/inetcf.c,v 1.3 2003/04/07 22:56:19 deraadt Exp $";
#endif
#endif

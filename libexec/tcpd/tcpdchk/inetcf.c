/*	$OpenBSD: src/libexec/tcpd/tcpdchk/inetcf.c,v 1.4 2003/06/26 07:53:27 deraadt Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/libexec/tcpd/tcpdchk/inetcf.c,v 1.4 2003/06/26 07:53:27 deraadt Exp $";
#endif
#endif

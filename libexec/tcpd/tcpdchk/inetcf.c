/*	$OpenBSD: src/libexec/tcpd/tcpdchk/inetcf.c,v 1.1 1997/02/26 06:17:07 downsj Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/libexec/tcpd/tcpdchk/inetcf.c,v 1.1 1997/02/26 06:17:07 downsj Exp $";
#endif
#endif

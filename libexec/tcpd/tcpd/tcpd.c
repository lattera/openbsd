/*	$OpenBSD: src/libexec/tcpd/tcpd/tcpd.c,v 1.1 1997/02/26 06:17:05 downsj Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/libexec/tcpd/tcpd/tcpd.c,v 1.1 1997/02/26 06:17:05 downsj Exp $";
#endif
#endif

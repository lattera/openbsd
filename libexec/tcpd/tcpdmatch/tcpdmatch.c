/*	$OpenBSD: src/libexec/tcpd/tcpdmatch/tcpdmatch.c,v 1.5 2000/10/14 00:56:15 itojun Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/libexec/tcpd/tcpdmatch/tcpdmatch.c,v 1.5 2000/10/14 00:56:15 itojun Exp $";
#endif
#endif

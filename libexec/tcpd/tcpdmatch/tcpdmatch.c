/*	$OpenBSD: src/libexec/tcpd/tcpdmatch/tcpdmatch.c,v 1.4 1999/06/06 18:58:54 deraadt Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/libexec/tcpd/tcpdmatch/tcpdmatch.c,v 1.4 1999/06/06 18:58:54 deraadt Exp $";
#endif
#endif

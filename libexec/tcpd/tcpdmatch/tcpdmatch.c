/*	$OpenBSD: src/libexec/tcpd/tcpdmatch/tcpdmatch.c,v 1.6 2002/06/07 03:32:04 itojun Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/libexec/tcpd/tcpdmatch/tcpdmatch.c,v 1.6 2002/06/07 03:32:04 itojun Exp $";
#endif
#endif

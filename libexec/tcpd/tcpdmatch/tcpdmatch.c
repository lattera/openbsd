/*	$OpenBSD: src/libexec/tcpd/tcpdmatch/tcpdmatch.c,v 1.3 1999/06/06 15:34:57 deraadt Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/libexec/tcpd/tcpdmatch/tcpdmatch.c,v 1.3 1999/06/06 15:34:57 deraadt Exp $";
#endif
#endif

/*	$OpenBSD: src/libexec/tcpd/safe_finger/safe_finger.c,v 1.1 1997/02/26 06:17:03 downsj Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/libexec/tcpd/safe_finger/safe_finger.c,v 1.1 1997/02/26 06:17:03 downsj Exp $";
#endif
#endif

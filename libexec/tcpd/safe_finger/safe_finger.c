/*	$OpenBSD: src/libexec/tcpd/safe_finger/safe_finger.c,v 1.3 2002/02/16 21:27:31 millert Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/libexec/tcpd/safe_finger/safe_finger.c,v 1.3 2002/02/16 21:27:31 millert Exp $";
#endif
#endif

/*	$OpenBSD: src/libexec/tcpd/safe_finger/safe_finger.c,v 1.2 2001/01/17 19:24:28 deraadt Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/libexec/tcpd/safe_finger/safe_finger.c,v 1.2 2001/01/17 19:24:28 deraadt Exp $";
#endif
#endif

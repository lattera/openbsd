/*	$OpenBSD: src/libexec/rpc.rstatd/rstat_proc.c,v 1.24 2003/07/29 18:39:23 deraadt Exp $	*/
...
static char rcsid[] = "$OpenBSD: src/libexec/rpc.rstatd/rstat_proc.c,v 1.24 2003/07/29 18:39:23 deraadt Exp $";
#endif

/*	$OpenBSD: src/lib/librpcsvc/sm_inter.x,v 1.2 1997/08/19 07:54:51 niklas Exp $	*/
...
%static char rcsid[] = "$OpenBSD: src/lib/librpcsvc/sm_inter.x,v 1.2 1997/08/19 07:54:51 niklas Exp $";
%#endif /* not lint */
#endif

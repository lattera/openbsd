/*	$OpenBSD: src/lib/librpcsvc/rnusers.x,v 1.7 1998/02/11 04:32:28 gene Exp $	*/
...
% static char rcsid[] = "$OpenBSD: src/lib/librpcsvc/rnusers.x,v 1.7 1998/02/11 04:32:28 gene Exp $";
%#endif /* not lint */
#endif

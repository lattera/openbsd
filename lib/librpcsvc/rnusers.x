/*	$OpenBSD: src/lib/librpcsvc/rnusers.x,v 1.10 2003/06/26 23:19:53 deraadt Exp $	*/
...
%static char rcsid[] = "$OpenBSD: src/lib/librpcsvc/rnusers.x,v 1.10 2003/06/26 23:19:53 deraadt Exp $";
%#endif /* not lint */
#endif

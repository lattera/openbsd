/*	$OpenBSD: src/lib/librpcsvc/rnusers.x,v 1.6 1997/08/19 07:54:49 niklas Exp $	*/
...
%static char rcsid[] = "$OpenBSD: src/lib/librpcsvc/rnusers.x,v 1.6 1997/08/19 07:54:49 niklas Exp $";
%#endif /* not lint */
#endif

/*	$OpenBSD: src/lib/librpcsvc/rnusers.x,v 1.8 1998/02/11 04:40:40 deraadt Exp $	*/
...
%static char rcsid[] = "$OpenBSD: src/lib/librpcsvc/rnusers.x,v 1.8 1998/02/11 04:40:40 deraadt Exp $";
%#endif /* not lint */
#endif

/*	$OpenBSD: src/lib/librpcsvc/rnusers.x,v 1.9 2003/06/19 10:10:10 deraadt Exp $	*/
...
%static char rcsid[] = "$OpenBSD: src/lib/librpcsvc/rnusers.x,v 1.9 2003/06/19 10:10:10 deraadt Exp $";
%#endif /* not lint */
#endif

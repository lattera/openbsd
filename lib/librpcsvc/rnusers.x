/*	$OpenBSD: src/lib/librpcsvc/rnusers.x,v 1.11 2003/07/10 07:51:03 deraadt Exp $	*/
...
%static char rcsid[] = "$OpenBSD: src/lib/librpcsvc/rnusers.x,v 1.11 2003/07/10 07:51:03 deraadt Exp $";
%#endif /* not lint */
#endif

/*	$OpenBSD: src/lib/librpcsvc/yppasswd.x,v 1.2 1997/08/19 07:54:53 niklas Exp $	*/
...
%static char rcsid[] = "$OpenBSD: src/lib/librpcsvc/yppasswd.x,v 1.2 1997/08/19 07:54:53 niklas Exp $";
%#endif /* not lint */
#endif

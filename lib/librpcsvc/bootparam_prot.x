/*	$OpenBSD: src/lib/librpcsvc/bootparam_prot.x,v 1.4 1997/08/19 07:54:46 niklas Exp $	*/
...
%static char rcsid[] = "$OpenBSD: src/lib/librpcsvc/bootparam_prot.x,v 1.4 1997/08/19 07:54:46 niklas Exp $";
%#endif /* not lint */
#endif

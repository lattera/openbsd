/*	$OpenBSD: src/lib/librpcsvc/bootparam_prot.x,v 1.5 2003/12/25 19:05:09 deraadt Exp $	*/
...
%static char rcsid[] = "$OpenBSD: src/lib/librpcsvc/bootparam_prot.x,v 1.5 2003/12/25 19:05:09 deraadt Exp $";
%#endif /* not lint */
#endif

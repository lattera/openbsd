/*	$OpenBSD: src/lib/librpcsvc/bootparam_prot.x,v 1.7 2005/12/21 01:40:23 millert Exp $	*/
...
%static char rcsid[] = "$OpenBSD: src/lib/librpcsvc/bootparam_prot.x,v 1.7 2005/12/21 01:40:23 millert Exp $";
%#endif /* not lint */
#endif

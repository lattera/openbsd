/*	$OpenBSD: src/lib/librpcsvc/klm_prot.x,v 1.3 2002/01/21 17:30:38 deraadt Exp $	*/
...
%static char rcsid[] = "$OpenBSD: src/lib/librpcsvc/klm_prot.x,v 1.3 2002/01/21 17:30:38 deraadt Exp $";
%#endif /* not lint */
#endif

/*	$OpenBSD: src/lib/librpcsvc/klm_prot.x,v 1.2 1997/08/19 07:54:47 niklas Exp $	*/
...
%static char rcsid[] = "$OpenBSD: src/lib/librpcsvc/klm_prot.x,v 1.2 1997/08/19 07:54:47 niklas Exp $";
%#endif /* not lint */
#endif

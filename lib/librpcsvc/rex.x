/*	$OpenBSD: src/lib/librpcsvc/rex.x,v 1.2 1997/08/19 07:54:49 niklas Exp $	*/
...
%static char rcsid[] = "$OpenBSD: src/lib/librpcsvc/rex.x,v 1.2 1997/08/19 07:54:49 niklas Exp $";
%#endif /* not lint */
#endif

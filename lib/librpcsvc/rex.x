/*	$OpenBSD: src/lib/librpcsvc/rex.x,v 1.3 2004/01/17 12:32:11 deraadt Exp $	*/
...
%static char rcsid[] = "$OpenBSD: src/lib/librpcsvc/rex.x,v 1.3 2004/01/17 12:32:11 deraadt Exp $";
%#endif /* not lint */
#endif

/*	$OpenBSD: src/lib/librpcsvc/yp.x,v 1.5 2004/01/17 12:32:11 deraadt Exp $	*/
...
%static char rcsid[] = "$OpenBSD: src/lib/librpcsvc/yp.x,v 1.5 2004/01/17 12:32:11 deraadt Exp $";
%#endif /* not lint */
#endif

/*	$OpenBSD: src/lib/librpcsvc/yp.x,v 1.4 2003/07/10 07:51:13 deraadt Exp $	*/
...
%static char rcsid[] = "$OpenBSD: src/lib/librpcsvc/yp.x,v 1.4 2003/07/10 07:51:13 deraadt Exp $";
%#endif /* not lint */
#endif

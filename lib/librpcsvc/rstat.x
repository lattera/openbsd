/*	$OpenBSD: src/lib/librpcsvc/rstat.x,v 1.4 2004/01/17 12:32:11 deraadt Exp $	*/
...
%static char rcsid[] = "$OpenBSD: src/lib/librpcsvc/rstat.x,v 1.4 2004/01/17 12:32:11 deraadt Exp $";
%#endif /* not lint */

/*	$OpenBSD: src/lib/librpcsvc/rstat.x,v 1.3 2003/06/19 10:10:19 deraadt Exp $	*/
...
%static char rcsid[] = "$OpenBSD: src/lib/librpcsvc/rstat.x,v 1.3 2003/06/19 10:10:19 deraadt Exp $";
%#endif /* not lint */

/*	$OpenBSD: src/lib/librpcsvc/nlm_prot.x,v 1.5 2008/06/13 21:24:15 sturm Exp $	*/
...
%static char rcsid[] = "$OpenBSD: src/lib/librpcsvc/nlm_prot.x,v 1.5 2008/06/13 21:24:15 sturm Exp $";
%#endif /* not lint */
#endif

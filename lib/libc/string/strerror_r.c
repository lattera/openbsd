/* $OpenBSD: src/lib/libc/string/strerror_r.c,v 1.4 2005/05/08 06:25:44 otto Exp $ */
/* Public Domain <marc@snafu.org> */

#if defined(LIBC_SCCS) && !defined(lint)
static char *rcsid = "$OpenBSD: src/lib/libc/string/strerror_r.c,v 1.4 2005/05/08 06:25:44 otto Exp $";

/* $OpenBSD: src/lib/libc/string/strerror_r.c,v 1.3 2005/04/20 23:38:15 beck Exp $ */
/* Public Domain <marc@snafu.org> */

#if defined(LIBC_SCCS) && !defined(lint)
static char *rcsid = "$OpenBSD: src/lib/libc/string/strerror_r.c,v 1.3 2005/04/20 23:38:15 beck Exp $";

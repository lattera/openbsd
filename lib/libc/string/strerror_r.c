/* $OpenBSD: src/lib/libc/string/strerror_r.c,v 1.2 2004/05/03 05:07:34 espie Exp $ */
/* Public Domain <marc@snafu.org> */

#if defined(LIBC_SCCS) && !defined(lint)
static char *rcsid = "$OpenBSD: src/lib/libc/string/strerror_r.c,v 1.2 2004/05/03 05:07:34 espie Exp $";

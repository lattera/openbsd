/* $OpenBSD: src/lib/libc/string/strerror_r.c,v 1.5 2005/05/26 12:56:01 otto Exp $ */
/* Public Domain <marc@snafu.org> */

#if defined(LIBC_SCCS) && !defined(lint)
static char *rcsid = "$OpenBSD: src/lib/libc/string/strerror_r.c,v 1.5 2005/05/26 12:56:01 otto Exp $";

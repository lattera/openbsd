/*	$OpenBSD: src/lib/libc/net/inet_net_ntop.c,v 1.3 2002/08/19 03:01:54 itojun Exp $	*/
...
#else
static const char rcsid[] = "$OpenBSD: src/lib/libc/net/inet_net_ntop.c,v 1.3 2002/08/19 03:01:54 itojun Exp $";
#endif
#endif

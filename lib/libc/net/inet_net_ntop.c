/*	$OpenBSD: src/lib/libc/net/inet_net_ntop.c,v 1.4 2004/09/15 19:01:28 deraadt Exp $	*/
...
#else
static const char rcsid[] = "$OpenBSD: src/lib/libc/net/inet_net_ntop.c,v 1.4 2004/09/15 19:01:28 deraadt Exp $";
#endif
#endif

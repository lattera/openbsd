/*	$OpenBSD: src/lib/libc/net/inet_net_ntop.c,v 1.5 2005/03/25 13:24:12 otto Exp $	*/
...
#else
static const char rcsid[] = "$OpenBSD: src/lib/libc/net/inet_net_ntop.c,v 1.5 2005/03/25 13:24:12 otto Exp $";
#endif
#endif

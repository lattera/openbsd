/*	$OpenBSD: src/lib/libc/net/inet_neta.c,v 1.4 2002/08/19 03:01:54 itojun Exp $	*/
...
#else
static const char rcsid[] = "$OpenBSD: src/lib/libc/net/inet_neta.c,v 1.4 2002/08/19 03:01:54 itojun Exp $";
#endif
#endif

/*	$OpenBSD: src/lib/libc/net/inet_neta.c,v 1.6 2005/03/25 13:24:12 otto Exp $	*/
...
static const char rcsid[] = "$OpenBSD: src/lib/libc/net/inet_neta.c,v 1.6 2005/03/25 13:24:12 otto Exp $";
#endif

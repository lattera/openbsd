/*	$OpenBSD: src/lib/libc/net/rcmdsh.c,v 1.5 1998/04/25 16:23:58 millert Exp $	*/ 
...
static char *rcsid = "$OpenBSD: src/lib/libc/net/rcmdsh.c,v 1.5 1998/04/25 16:23:58 millert Exp $";

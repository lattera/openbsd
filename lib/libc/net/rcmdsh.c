/*	$OpenBSD: src/lib/libc/net/rcmdsh.c,v 1.3 1996/09/15 09:31:17 tholo Exp $	*/ 
...
static char *rcsid = "$OpenBSD: src/lib/libc/net/rcmdsh.c,v 1.3 1996/09/15 09:31:17 tholo Exp $";

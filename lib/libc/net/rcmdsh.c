/*	$OpenBSD: src/lib/libc/net/rcmdsh.c,v 1.6 2002/01/02 20:18:32 deraadt Exp $	*/ 
...
static char *rcsid = "$OpenBSD: src/lib/libc/net/rcmdsh.c,v 1.6 2002/01/02 20:18:32 deraadt Exp $";

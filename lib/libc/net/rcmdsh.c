/*	$OpenBSD: src/lib/libc/net/rcmdsh.c,v 1.2 1996/09/01 20:28:22 millert Exp $	*/ 
...
static char *rcsid = "$OpenBSD: src/lib/libc/net/rcmdsh.c,v 1.2 1996/09/01 20:28:22 millert Exp $";

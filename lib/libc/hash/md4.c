/*	$OpenBSD: src/lib/libc/hash/md4.c,v 1.6 2004/05/28 15:10:27 millert Exp $	*/
...
static const char rcsid[] = "$OpenBSD: src/lib/libc/hash/md4.c,v 1.6 2004/05/28 15:10:27 millert Exp $";

/*	$OpenBSD: src/lib/libc/hash/md5.c,v 1.1 2004/04/28 16:46:03 millert Exp $	*/
...
static const char rcsid[] = "$OpenBSD: src/lib/libc/hash/md5.c,v 1.1 2004/04/28 16:46:03 millert Exp $";

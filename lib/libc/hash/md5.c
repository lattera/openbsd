/*	$OpenBSD: src/lib/libc/hash/md5.c,v 1.2 2004/04/28 16:52:08 millert Exp $	*/
...
static const char rcsid[] = "$OpenBSD: src/lib/libc/hash/md5.c,v 1.2 2004/04/28 16:52:08 millert Exp $";

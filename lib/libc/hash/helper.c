/*	$OpenBSD: src/lib/libc/hash/helper.c,v 1.5 2004/05/03 17:30:14 millert Exp $	*/
...
static const char rcsid[] = "$OpenBSD: src/lib/libc/hash/helper.c,v 1.5 2004/05/03 17:30:14 millert Exp $";

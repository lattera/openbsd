/*	$OpenBSD: src/lib/libc/hash/helper.c,v 1.2 2004/04/29 02:39:32 millert Exp $	*/
...
static const char rcsid[] = "$OpenBSD: src/lib/libc/hash/helper.c,v 1.2 2004/04/29 02:39:32 millert Exp $";

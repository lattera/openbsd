/*	$OpenBSD: src/lib/libc/hash/helper.c,v 1.4 2004/04/29 15:51:16 millert Exp $	*/
...
static const char rcsid[] = "$OpenBSD: src/lib/libc/hash/helper.c,v 1.4 2004/04/29 15:51:16 millert Exp $";

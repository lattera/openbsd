/*	$OpenBSD: src/lib/libc/hash/sha1.c,v 1.10 2002/12/23 04:33:31 millert Exp $	*/
...
static char rcsid[] = "$OpenBSD: src/lib/libc/hash/sha1.c,v 1.10 2002/12/23 04:33:31 millert Exp $";

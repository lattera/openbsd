/*	$OpenBSD: src/lib/libc/hash/sha1.c,v 1.16 2004/05/03 17:30:15 millert Exp $	*/
...
static char rcsid[] = "$OpenBSD: src/lib/libc/hash/sha1.c,v 1.16 2004/05/03 17:30:15 millert Exp $";

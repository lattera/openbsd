/*	$OpenBSD: src/lib/libc/rpc/pmap_prot2.c,v 1.2 1996/07/20 06:12:34 deraadt Exp $	*/
...
static char *rcsid = "$OpenBSD: src/lib/libc/rpc/pmap_prot2.c,v 1.2 1996/07/20 06:12:34 deraadt Exp $";
#endif

/*	$OpenBSD: src/lib/libc/rpc/svc_auth.c,v 1.2 1996/07/20 06:12:41 deraadt Exp $	*/
...
static char *rcsid = "$OpenBSD: src/lib/libc/rpc/svc_auth.c,v 1.2 1996/07/20 06:12:41 deraadt Exp $";
#endif

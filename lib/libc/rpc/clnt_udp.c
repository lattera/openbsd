/*	$OpenBSD: src/lib/libc/rpc/clnt_udp.c,v 1.5 1996/08/15 07:27:48 deraadt Exp $	*/
...
static char *rcsid = "$OpenBSD: src/lib/libc/rpc/clnt_udp.c,v 1.5 1996/08/15 07:27:48 deraadt Exp $";
#endif

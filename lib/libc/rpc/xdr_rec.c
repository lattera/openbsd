/*	$OpenBSD: src/lib/libc/rpc/xdr_rec.c,v 1.3 1996/07/20 06:12:51 deraadt Exp $	*/
...
static char *rcsid = "$OpenBSD: src/lib/libc/rpc/xdr_rec.c,v 1.3 1996/07/20 06:12:51 deraadt Exp $";
#endif

/*	$OpenBSD: src/lib/libc/rpc/bindresvport.c,v 1.6 1996/07/30 10:55:22 deraadt Exp $	*/
...
static char *rcsid = "$OpenBSD: src/lib/libc/rpc/bindresvport.c,v 1.6 1996/07/30 10:55:22 deraadt Exp $";
#endif

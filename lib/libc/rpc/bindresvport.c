/*	$OpenBSD: src/lib/libc/rpc/bindresvport.c,v 1.4 1996/07/29 06:51:25 downsj Exp $	*/
...
static char *rcsid = "$OpenBSD: src/lib/libc/rpc/bindresvport.c,v 1.4 1996/07/29 06:51:25 downsj Exp $";
#endif

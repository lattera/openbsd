/*	$OpenBSD: src/lib/libc/rpc/bindresvport.c,v 1.5 1996/07/30 10:52:49 deraadt Exp $	*/
...
static char *rcsid = "$OpenBSD: src/lib/libc/rpc/bindresvport.c,v 1.5 1996/07/30 10:52:49 deraadt Exp $";
#endif

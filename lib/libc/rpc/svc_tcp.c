/*	$OpenBSD: src/lib/libc/rpc/svc_tcp.c,v 1.5 1996/08/15 07:27:50 deraadt Exp $	*/
...
static char *rcsid = "$OpenBSD: src/lib/libc/rpc/svc_tcp.c,v 1.5 1996/08/15 07:27:50 deraadt Exp $";
#endif

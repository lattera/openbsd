/*	$OpenBSD: src/lib/libc/rpc/svc_tcp.c,v 1.4 1996/08/05 00:34:28 deraadt Exp $	*/
...
static char *rcsid = "$OpenBSD: src/lib/libc/rpc/svc_tcp.c,v 1.4 1996/08/05 00:34:28 deraadt Exp $";
#endif

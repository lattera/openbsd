/*	$OpenBSD: src/lib/libc/rpc/pmap_getmaps.c,v 1.2 1996/07/20 06:12:31 deraadt Exp $	*/
...
static char *rcsid = "$OpenBSD: src/lib/libc/rpc/pmap_getmaps.c,v 1.2 1996/07/20 06:12:31 deraadt Exp $";
#endif

/*	$OpenBSD: src/lib/libc/rpc/pmap_clnt.c,v 1.4 1996/07/20 06:12:30 deraadt Exp $	*/
...
static char *rcsid = "$OpenBSD: src/lib/libc/rpc/pmap_clnt.c,v 1.4 1996/07/20 06:12:30 deraadt Exp $";
#endif

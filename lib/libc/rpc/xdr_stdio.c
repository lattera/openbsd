/*	$OpenBSD: src/lib/libc/rpc/xdr_stdio.c,v 1.2 1996/07/20 06:12:53 deraadt Exp $	*/
...
static char *rcsid = "$OpenBSD: src/lib/libc/rpc/xdr_stdio.c,v 1.2 1996/07/20 06:12:53 deraadt Exp $";
#endif

/*	$OpenBSD: src/lib/libc/rpc/rpc_dtablesize.c,v 1.3 1996/08/13 06:37:42 deraadt Exp $	*/
...
static char *rcsid = "$OpenBSD: src/lib/libc/rpc/rpc_dtablesize.c,v 1.3 1996/08/13 06:37:42 deraadt Exp $";
#endif

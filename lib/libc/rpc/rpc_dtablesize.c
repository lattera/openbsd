/*	$OpenBSD: src/lib/libc/rpc/rpc_dtablesize.c,v 1.2 1996/07/20 06:12:38 deraadt Exp $	*/
...
static char *rcsid = "$OpenBSD: src/lib/libc/rpc/rpc_dtablesize.c,v 1.2 1996/07/20 06:12:38 deraadt Exp $";
#endif

/*	$OpenBSD: src/lib/libc/rpc/getrpcport.c,v 1.3 1996/07/20 06:12:30 deraadt Exp $	*/
...
static char *rcsid = "$OpenBSD: src/lib/libc/rpc/getrpcport.c,v 1.3 1996/07/20 06:12:30 deraadt Exp $";
#endif

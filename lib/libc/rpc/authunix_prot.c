/*	$OpenBSD: src/lib/libc/rpc/authunix_prot.c,v 1.2 1996/07/20 06:12:18 deraadt Exp $	*/
...
static char *rcsid = "$OpenBSD: src/lib/libc/rpc/authunix_prot.c,v 1.2 1996/07/20 06:12:18 deraadt Exp $";
#endif

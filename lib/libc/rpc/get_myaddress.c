/*	$OpenBSD: src/lib/libc/rpc/get_myaddress.c,v 1.4 1996/07/20 06:12:26 deraadt Exp $	*/
...
static char *rcsid = "$OpenBSD: src/lib/libc/rpc/get_myaddress.c,v 1.4 1996/07/20 06:12:26 deraadt Exp $";
#endif

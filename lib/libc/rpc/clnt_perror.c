/*	$OpenBSD: src/lib/libc/rpc/clnt_perror.c,v 1.2 1996/07/20 06:12:22 deraadt Exp $	*/
...
static char *rcsid = "$OpenBSD: src/lib/libc/rpc/clnt_perror.c,v 1.2 1996/07/20 06:12:22 deraadt Exp $";
#endif

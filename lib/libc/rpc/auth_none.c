/*	$OpenBSD: src/lib/libc/rpc/auth_none.c,v 1.2 1996/07/20 06:12:16 deraadt Exp $	*/
...
static char *rcsid = "$OpenBSD: src/lib/libc/rpc/auth_none.c,v 1.2 1996/07/20 06:12:16 deraadt Exp $";
#endif

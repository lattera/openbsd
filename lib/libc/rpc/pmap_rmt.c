/*	$OpenBSD: src/lib/libc/rpc/pmap_rmt.c,v 1.6 1996/08/15 07:27:49 deraadt Exp $	*/
...
static char *rcsid = "$OpenBSD: src/lib/libc/rpc/pmap_rmt.c,v 1.6 1996/08/15 07:27:49 deraadt Exp $";
#endif

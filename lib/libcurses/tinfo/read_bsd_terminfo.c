/*	$OpenBSD: src/lib/libcurses/tinfo/read_bsd_terminfo.c,v 1.14 2003/06/17 21:56:24 millert Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/lib/libcurses/tinfo/read_bsd_terminfo.c,v 1.14 2003/06/17 21:56:24 millert Exp $";
#endif

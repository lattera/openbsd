/*	$OpenBSD: src/lib/libcurses/tinfo/read_bsd_terminfo.c,v 1.16 2009/10/18 13:51:44 nicm Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/lib/libcurses/tinfo/read_bsd_terminfo.c,v 1.16 2009/10/18 13:51:44 nicm Exp $";
#endif

/*	$OpenBSD: src/lib/libcurses/tinfo/read_bsd_terminfo.c,v 1.15 2009/08/28 11:43:50 nicm Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/lib/libcurses/tinfo/read_bsd_terminfo.c,v 1.15 2009/08/28 11:43:50 nicm Exp $";
#endif

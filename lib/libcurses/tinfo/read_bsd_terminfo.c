/*	$OpenBSD: src/lib/libcurses/tinfo/read_bsd_terminfo.c,v 1.13 2003/06/03 01:52:40 millert Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/lib/libcurses/tinfo/read_bsd_terminfo.c,v 1.13 2003/06/03 01:52:40 millert Exp $";
#endif

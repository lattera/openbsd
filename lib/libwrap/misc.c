/*	$OpenBSD: src/lib/libwrap/misc.c,v 1.2 1997/06/30 06:06:00 deraadt Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/misc.c,v 1.2 1997/06/30 06:06:00 deraadt Exp $";
#endif
#endif

/*	$OpenBSD: src/lib/libwrap/misc.c,v 1.5 2002/06/07 03:32:04 itojun Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/misc.c,v 1.5 2002/06/07 03:32:04 itojun Exp $";
#endif
#endif

/*	$OpenBSD: src/lib/libwrap/misc.c,v 1.4 2000/10/14 00:56:15 itojun Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/misc.c,v 1.4 2000/10/14 00:56:15 itojun Exp $";
#endif
#endif

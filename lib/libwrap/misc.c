/*	$OpenBSD: src/lib/libwrap/misc.c,v 1.6 2003/05/15 04:45:28 pjanzen Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/misc.c,v 1.6 2003/05/15 04:45:28 pjanzen Exp $";
#endif
#endif

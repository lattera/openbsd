/*	$OpenBSD: src/lib/libwrap/misc.c,v 1.3 1999/06/06 15:34:44 deraadt Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/misc.c,v 1.3 1999/06/06 15:34:44 deraadt Exp $";
#endif
#endif

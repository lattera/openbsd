/*	$OpenBSD: src/lib/libwrap/diag.c,v 1.2 2002/02/19 19:39:37 millert Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/diag.c,v 1.2 2002/02/19 19:39:37 millert Exp $";
#endif
#endif

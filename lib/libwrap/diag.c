/*	$OpenBSD: src/lib/libwrap/diag.c,v 1.3 2002/06/07 00:05:09 itojun Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/diag.c,v 1.3 2002/06/07 00:05:09 itojun Exp $";
#endif
#endif

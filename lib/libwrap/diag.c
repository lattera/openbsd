/*	$OpenBSD: src/lib/libwrap/diag.c,v 1.4 2002/06/19 07:12:42 deraadt Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/diag.c,v 1.4 2002/06/19 07:12:42 deraadt Exp $";
#endif
#endif

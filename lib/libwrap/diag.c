/*	$OpenBSD: src/lib/libwrap/diag.c,v 1.1 1997/02/26 03:06:50 downsj Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/diag.c,v 1.1 1997/02/26 03:06:50 downsj Exp $";
#endif
#endif

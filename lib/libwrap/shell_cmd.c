/*	$OpenBSD: src/lib/libwrap/shell_cmd.c,v 1.2 2002/01/02 20:18:33 deraadt Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/shell_cmd.c,v 1.2 2002/01/02 20:18:33 deraadt Exp $";
#endif
#endif

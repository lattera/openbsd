/*	$OpenBSD: src/lib/libwrap/shell_cmd.c,v 1.1 1997/02/26 03:06:57 downsj Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/shell_cmd.c,v 1.1 1997/02/26 03:06:57 downsj Exp $";
#endif
#endif

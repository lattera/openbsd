/*	$OpenBSD: src/lib/libwrap/rfc931.c,v 1.7 2002/04/25 10:58:39 mpech Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/lib/libwrap/rfc931.c,v 1.7 2002/04/25 10:58:39 mpech Exp $";
#endif

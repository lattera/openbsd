/*	$OpenBSD: src/lib/libwrap/rfc931.c,v 1.3 2001/02/15 20:55:12 beck Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/rfc931.c,v 1.3 2001/02/15 20:55:12 beck Exp $";
#endif
#endif

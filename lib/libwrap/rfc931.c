/*	$OpenBSD: src/lib/libwrap/rfc931.c,v 1.8 2002/06/03 12:04:08 deraadt Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/lib/libwrap/rfc931.c,v 1.8 2002/06/03 12:04:08 deraadt Exp $";
#endif

/*	$OpenBSD: src/lib/libwrap/options.c,v 1.3 2002/05/27 03:13:23 deraadt Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/options.c,v 1.3 2002/05/27 03:13:23 deraadt Exp $";
#endif
#endif

/*	$OpenBSD: src/lib/libwrap/options.c,v 1.2 1997/03/04 16:32:36 bitblt Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/options.c,v 1.2 1997/03/04 16:32:36 bitblt Exp $";
#endif
#endif

/*	$OpenBSD: src/lib/libwrap/options.c,v 1.4 2002/06/07 00:04:21 itojun Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/options.c,v 1.4 2002/06/07 00:04:21 itojun Exp $";
#endif
#endif

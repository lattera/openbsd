/*	$OpenBSD: src/lib/libwrap/options.c,v 1.5 2003/04/05 00:43:20 tdeval Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/options.c,v 1.5 2003/04/05 00:43:20 tdeval Exp $";
#endif
#endif

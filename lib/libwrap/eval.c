/*	$OpenBSD: src/lib/libwrap/eval.c,v 1.3 2002/06/07 00:03:34 itojun Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/eval.c,v 1.3 2002/06/07 00:03:34 itojun Exp $";
#endif
#endif

/*	$OpenBSD: src/lib/libwrap/eval.c,v 1.2 2001/11/07 18:49:21 deraadt Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/eval.c,v 1.2 2001/11/07 18:49:21 deraadt Exp $";
#endif
#endif

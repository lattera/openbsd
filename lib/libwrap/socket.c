/*	$OpenBSD: src/lib/libwrap/socket.c,v 1.2 1997/06/01 05:22:08 downsj Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/socket.c,v 1.2 1997/06/01 05:22:08 downsj Exp $";
#endif
#endif

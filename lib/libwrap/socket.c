/*	$OpenBSD: src/lib/libwrap/socket.c,v 1.1 1997/02/26 03:06:58 downsj Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/socket.c,v 1.1 1997/02/26 03:06:58 downsj Exp $";
#endif
#endif

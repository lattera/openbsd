/*	$OpenBSD: src/lib/libwrap/hosts_access.c,v 1.5 2000/02/01 03:23:17 deraadt Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/hosts_access.c,v 1.5 2000/02/01 03:23:17 deraadt Exp $";
#endif
#endif

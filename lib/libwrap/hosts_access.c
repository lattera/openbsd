/*	$OpenBSD: src/lib/libwrap/hosts_access.c,v 1.4 1999/06/06 15:34:44 deraadt Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/hosts_access.c,v 1.4 1999/06/06 15:34:44 deraadt Exp $";
#endif
#endif

/*	$OpenBSD: src/lib/libwrap/hosts_access.c,v 1.3 1997/06/30 06:05:59 deraadt Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/hosts_access.c,v 1.3 1997/06/30 06:05:59 deraadt Exp $";
#endif
#endif

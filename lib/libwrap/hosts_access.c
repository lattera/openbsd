/*	$OpenBSD: src/lib/libwrap/hosts_access.c,v 1.8 2002/06/07 03:32:04 itojun Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/hosts_access.c,v 1.8 2002/06/07 03:32:04 itojun Exp $";
#endif
#endif

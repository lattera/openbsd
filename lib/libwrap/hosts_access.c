/*	$OpenBSD: src/lib/libwrap/hosts_access.c,v 1.9 2002/06/22 02:13:12 deraadt Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/hosts_access.c,v 1.9 2002/06/22 02:13:12 deraadt Exp $";
#endif
#endif

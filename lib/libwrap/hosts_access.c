/*	$OpenBSD: src/lib/libwrap/hosts_access.c,v 1.1 1997/02/26 03:06:52 downsj Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/hosts_access.c,v 1.1 1997/02/26 03:06:52 downsj Exp $";
#endif
#endif

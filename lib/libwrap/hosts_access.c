/*	$OpenBSD: src/lib/libwrap/hosts_access.c,v 1.7 2001/12/13 17:44:47 beck Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/hosts_access.c,v 1.7 2001/12/13 17:44:47 beck Exp $";
#endif
#endif

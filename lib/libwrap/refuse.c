/*	$OpenBSD: src/lib/libwrap/refuse.c,v 1.1 1997/02/26 03:06:55 downsj Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/refuse.c,v 1.1 1997/02/26 03:06:55 downsj Exp $";
#endif
#endif

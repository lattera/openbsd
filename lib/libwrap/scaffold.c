/*	$OpenBSD: src/lib/libwrap/Attic/scaffold.c,v 1.1 1997/02/26 03:06:56 downsj Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/Attic/scaffold.c,v 1.1 1997/02/26 03:06:56 downsj Exp $";
#endif
#endif

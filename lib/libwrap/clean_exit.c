/*	$OpenBSD: src/lib/libwrap/clean_exit.c,v 1.2 2003/07/18 23:05:13 david Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/clean_exit.c,v 1.2 2003/07/18 23:05:13 david Exp $";
#endif
#endif

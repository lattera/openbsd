/*	$OpenBSD: src/lib/libwrap/clean_exit.c,v 1.1 1997/02/26 03:06:50 downsj Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/clean_exit.c,v 1.1 1997/02/26 03:06:50 downsj Exp $";
#endif
#endif

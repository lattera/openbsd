/*	$OpenBSD: src/lib/libwrap/update.c,v 1.5 2002/05/26 09:29:02 deraadt Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/update.c,v 1.5 2002/05/26 09:29:02 deraadt Exp $";
#endif
#endif

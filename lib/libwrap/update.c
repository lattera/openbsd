/*	$OpenBSD: src/lib/libwrap/update.c,v 1.1 1997/02/26 03:06:59 downsj Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/update.c,v 1.1 1997/02/26 03:06:59 downsj Exp $";
#endif
#endif

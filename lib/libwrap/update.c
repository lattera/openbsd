/*	$OpenBSD: src/lib/libwrap/update.c,v 1.2 2000/10/14 00:56:16 itojun Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/update.c,v 1.2 2000/10/14 00:56:16 itojun Exp $";
#endif
#endif

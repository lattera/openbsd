/*	$OpenBSD: src/lib/libwrap/update.c,v 1.3 2001/11/07 18:49:21 deraadt Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/update.c,v 1.3 2001/11/07 18:49:21 deraadt Exp $";
#endif
#endif

/*	$OpenBSD: src/lib/libwrap/update.c,v 1.4 2002/02/19 19:39:38 millert Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/lib/libwrap/update.c,v 1.4 2002/02/19 19:39:38 millert Exp $";
#endif
#endif

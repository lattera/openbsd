/*	$OpenBSD: src/usr.bin/newsyslog/newsyslog.c,v 1.7 1996/12/07 08:00:45 deraadt Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/newsyslog/newsyslog.c,v 1.7 1996/12/07 08:00:45 deraadt Exp $";
#endif /* not lint */

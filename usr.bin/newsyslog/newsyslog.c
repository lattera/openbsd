/*	$OpenBSD: src/usr.bin/newsyslog/newsyslog.c,v 1.8 1997/01/15 23:42:56 millert Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/newsyslog/newsyslog.c,v 1.8 1997/01/15 23:42:56 millert Exp $";
#endif /* not lint */

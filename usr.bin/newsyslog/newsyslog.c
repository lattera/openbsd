/*	$OpenBSD: src/usr.bin/newsyslog/newsyslog.c,v 1.5 1996/08/31 14:20:36 deraadt Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/newsyslog/newsyslog.c,v 1.5 1996/08/31 14:20:36 deraadt Exp $";
#endif /* not lint */

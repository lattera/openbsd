/*	$OpenBSD: src/usr.bin/newsyslog/newsyslog.c,v 1.4 1996/07/22 10:09:17 deraadt Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/newsyslog/newsyslog.c,v 1.4 1996/07/22 10:09:17 deraadt Exp $";
#endif /* not lint */

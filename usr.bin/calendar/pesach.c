/*	$OpenBSD: src/usr.bin/calendar/pesach.c,v 1.2 2004/12/10 20:50:45 mickey Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/calendar/pesach.c,v 1.2 2004/12/10 20:50:45 mickey Exp $";
#endif /* not lint */

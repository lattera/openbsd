/*	$OpenBSD: src/usr.bin/ssh/ssh-agent.c,v 1.24 1999/12/15 19:43:10 markus Exp $	*/
...
#include "includes.h"
RCSID("$OpenBSD: src/usr.bin/ssh/ssh-agent.c,v 1.24 1999/12/15 19:43:10 markus Exp $");

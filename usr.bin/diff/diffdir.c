/*	$OpenBSD: src/usr.bin/diff/diffdir.c,v 1.34 2009/06/07 08:39:13 ray Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/diff/diffdir.c,v 1.34 2009/06/07 08:39:13 ray Exp $";
#endif /* not lint */

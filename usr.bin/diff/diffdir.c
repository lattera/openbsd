/*	$OpenBSD: src/usr.bin/diff/diffdir.c,v 1.24 2003/07/21 23:28:00 millert Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/diff/diffdir.c,v 1.24 2003/07/21 23:28:00 millert Exp $";
#endif /* not lint */

/*	$OpenBSD: src/usr.bin/diff/diffdir.c,v 1.20 2003/07/06 22:02:36 millert Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/diff/diffdir.c,v 1.20 2003/07/06 22:02:36 millert Exp $";
#endif /* not lint */

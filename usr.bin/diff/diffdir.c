/*	$OpenBSD: src/usr.bin/diff/diffdir.c,v 1.25 2003/10/07 23:37:27 millert Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/diff/diffdir.c,v 1.25 2003/10/07 23:37:27 millert Exp $";
#endif /* not lint */

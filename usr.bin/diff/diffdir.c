/*	$OpenBSD: src/usr.bin/diff/diffdir.c,v 1.31 2007/05/29 18:24:56 ray Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/diff/diffdir.c,v 1.31 2007/05/29 18:24:56 ray Exp $";
#endif /* not lint */

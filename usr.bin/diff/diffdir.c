/*	$OpenBSD: src/usr.bin/diff/diffdir.c,v 1.30 2005/06/15 18:44:01 millert Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/diff/diffdir.c,v 1.30 2005/06/15 18:44:01 millert Exp $";
#endif /* not lint */

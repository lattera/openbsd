/*	$OpenBSD: src/usr.bin/diff/diffdir.c,v 1.22 2003/07/09 00:07:44 millert Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/diff/diffdir.c,v 1.22 2003/07/09 00:07:44 millert Exp $";
#endif /* not lint */

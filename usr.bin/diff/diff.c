/*	$OpenBSD: src/usr.bin/diff/diff.c,v 1.53 2009/06/07 08:39:13 ray Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/diff/diff.c,v 1.53 2009/06/07 08:39:13 ray Exp $";
#endif /* not lint */

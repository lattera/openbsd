/*	$OpenBSD: src/usr.bin/diff/diff.c,v 1.52 2009/06/06 15:37:28 ray Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/diff/diff.c,v 1.52 2009/06/06 15:37:28 ray Exp $";
#endif /* not lint */

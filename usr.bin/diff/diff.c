/*	$OpenBSD: src/usr.bin/diff/diff.c,v 1.45 2004/03/16 00:40:34 millert Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/diff/diff.c,v 1.45 2004/03/16 00:40:34 millert Exp $";
#endif /* not lint */

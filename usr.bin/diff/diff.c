/*	$OpenBSD: src/usr.bin/diff/diff.c,v 1.51 2009/06/06 15:00:27 ray Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/diff/diff.c,v 1.51 2009/06/06 15:00:27 ray Exp $";
#endif /* not lint */

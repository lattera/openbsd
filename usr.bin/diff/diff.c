/*	$OpenBSD: src/usr.bin/diff/diff.c,v 1.34 2003/07/22 16:42:58 millert Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/diff/diff.c,v 1.34 2003/07/22 16:42:58 millert Exp $";
#endif /* not lint */

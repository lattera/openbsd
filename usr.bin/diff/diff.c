/*	$OpenBSD: src/usr.bin/diff/diff.c,v 1.32 2003/07/21 23:02:35 millert Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/diff/diff.c,v 1.32 2003/07/21 23:02:35 millert Exp $";
#endif /* not lint */

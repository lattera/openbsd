/*	$OpenBSD: src/usr.bin/diff/diff.c,v 1.27 2003/07/09 00:07:44 millert Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/diff/diff.c,v 1.27 2003/07/09 00:07:44 millert Exp $";
#endif /* not lint */

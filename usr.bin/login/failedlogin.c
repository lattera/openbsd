/*	$OpenBSD: src/usr.bin/login/failedlogin.c,v 1.13 2003/06/03 01:52:41 millert Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/login/failedlogin.c,v 1.13 2003/06/03 01:52:41 millert Exp $";
#endif /* not lint */

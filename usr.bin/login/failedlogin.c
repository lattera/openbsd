/*	$OpenBSD: src/usr.bin/login/failedlogin.c,v 1.14 2003/06/17 21:56:25 millert Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/login/failedlogin.c,v 1.14 2003/06/17 21:56:25 millert Exp $";
#endif /* not lint */

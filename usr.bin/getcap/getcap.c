/*	$OpenBSD: src/usr.bin/getcap/getcap.c,v 1.2 2006/01/28 22:35:54 millert Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/getcap/getcap.c,v 1.2 2006/01/28 22:35:54 millert Exp $";
#endif /* not lint */

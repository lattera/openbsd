/*	$OpenBSD: src/usr.bin/getcap/getcap.c,v 1.1 2005/02/19 22:15:41 millert Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/getcap/getcap.c,v 1.1 2005/02/19 22:15:41 millert Exp $";
#endif /* not lint */

/*	$OpenBSD: src/usr.bin/file/print.c,v 1.6 1998/07/10 15:05:25 mickey Exp $	*/
...
#ifndef lint
static char *moduleid = "$OpenBSD: src/usr.bin/file/print.c,v 1.6 1998/07/10 15:05:25 mickey Exp $";
#endif  /* lint */

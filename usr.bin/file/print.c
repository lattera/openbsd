/*	$OpenBSD: src/usr.bin/file/print.c,v 1.8 2003/03/03 22:24:08 ian Exp $	*/
...
#ifndef lint
static char *moduleid = "$OpenBSD: src/usr.bin/file/print.c,v 1.8 2003/03/03 22:24:08 ian Exp $";
#endif  /* lint */

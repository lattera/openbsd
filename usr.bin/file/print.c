/*	$OpenBSD: src/usr.bin/file/print.c,v 1.5 1997/08/24 18:33:12 millert Exp $	*/
...
#ifndef lint
static char *moduleid = "$OpenBSD: src/usr.bin/file/print.c,v 1.5 1997/08/24 18:33:12 millert Exp $";
#endif  /* lint */

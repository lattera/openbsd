/*	$OpenBSD: src/usr.bin/file/print.c,v 1.3 1997/02/09 23:58:32 millert Exp $	*/
...
#ifndef lint
static char *moduleid = "$OpenBSD: src/usr.bin/file/print.c,v 1.3 1997/02/09 23:58:32 millert Exp $";
#endif  /* lint */

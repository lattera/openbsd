/*	$OpenBSD: src/usr.bin/file/print.c,v 1.7 2002/02/19 19:39:38 millert Exp $	*/
...
#ifndef lint
static char *moduleid = "$OpenBSD: src/usr.bin/file/print.c,v 1.7 2002/02/19 19:39:38 millert Exp $";
#endif  /* lint */

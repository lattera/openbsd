/*	$OpenBSD: src/usr.bin/file/print.c,v 1.4 1997/07/25 21:05:26 mickey Exp $	*/
...
#ifndef lint
static char *moduleid = "$OpenBSD: src/usr.bin/file/print.c,v 1.4 1997/07/25 21:05:26 mickey Exp $";
#endif  /* lint */

/*	$OpenBSD: src/usr.bin/file/ascmagic.c,v 1.4 1998/07/10 15:05:15 mickey Exp $	*/
...
#ifndef	lint
static char *moduleid = "$OpenBSD: src/usr.bin/file/ascmagic.c,v 1.4 1998/07/10 15:05:15 mickey Exp $";
#endif	/* lint */

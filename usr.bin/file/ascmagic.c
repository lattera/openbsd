/*	$OpenBSD: src/usr.bin/file/ascmagic.c,v 1.5 2001/11/19 19:02:13 mpech Exp $	*/
...
#ifndef	lint
static char *moduleid = "$OpenBSD: src/usr.bin/file/ascmagic.c,v 1.5 2001/11/19 19:02:13 mpech Exp $";
#endif	/* lint */

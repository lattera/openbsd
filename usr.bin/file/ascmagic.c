/*	$OpenBSD: src/usr.bin/file/ascmagic.c,v 1.3 1997/02/09 23:58:18 millert Exp $	*/
...
#ifndef	lint
static char *moduleid = "$OpenBSD: src/usr.bin/file/ascmagic.c,v 1.3 1997/02/09 23:58:18 millert Exp $";
#endif	/* lint */

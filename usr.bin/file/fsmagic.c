/*	$OpenBSD: src/usr.bin/file/fsmagic.c,v 1.4 1998/07/10 15:05:22 mickey Exp $	*/
...
#ifndef	lint
static char *moduleid = "$OpenBSD: src/usr.bin/file/fsmagic.c,v 1.4 1998/07/10 15:05:22 mickey Exp $";
#endif	/* lint */

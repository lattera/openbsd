/*	$OpenBSD: src/usr.bin/file/fsmagic.c,v 1.6 2001/11/19 19:02:13 mpech Exp $	*/
...
#ifndef	lint
static char *moduleid = "$OpenBSD: src/usr.bin/file/fsmagic.c,v 1.6 2001/11/19 19:02:13 mpech Exp $";
#endif	/* lint */

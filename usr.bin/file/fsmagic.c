/*	$OpenBSD: src/usr.bin/file/fsmagic.c,v 1.3 1997/02/09 23:58:24 millert Exp $	*/
...
#ifndef	lint
static char *moduleid = "$OpenBSD: src/usr.bin/file/fsmagic.c,v 1.3 1997/02/09 23:58:24 millert Exp $";
#endif	/* lint */

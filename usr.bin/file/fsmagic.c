/*	$OpenBSD: src/usr.bin/file/fsmagic.c,v 1.5 1999/12/06 00:32:29 deraadt Exp $	*/
...
#ifndef	lint
static char *moduleid = "$OpenBSD: src/usr.bin/file/fsmagic.c,v 1.5 1999/12/06 00:32:29 deraadt Exp $";
#endif	/* lint */

/*	$OpenBSD: src/usr.bin/file/softmagic.c,v 1.4 1998/07/10 15:05:27 mickey Exp $	*/
...
#ifndef	lint
static char *moduleid = "$OpenBSD: src/usr.bin/file/softmagic.c,v 1.4 1998/07/10 15:05:27 mickey Exp $";
#endif	/* lint */

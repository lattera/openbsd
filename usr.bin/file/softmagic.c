/*	$OpenBSD: src/usr.bin/file/softmagic.c,v 1.7 2002/02/17 19:42:30 millert Exp $	*/
...
#ifndef	lint
static char *moduleid = "$OpenBSD: src/usr.bin/file/softmagic.c,v 1.7 2002/02/17 19:42:30 millert Exp $";
#endif	/* lint */

/*	$OpenBSD: src/usr.bin/file/softmagic.c,v 1.6 2002/02/16 21:27:46 millert Exp $	*/
...
#ifndef	lint
static char *moduleid = "$OpenBSD: src/usr.bin/file/softmagic.c,v 1.6 2002/02/16 21:27:46 millert Exp $";
#endif	/* lint */

/*	$OpenBSD: src/usr.bin/file/apprentice.c,v 1.5 1998/07/10 15:05:13 mickey Exp $	*/
...
#ifndef	lint
static char *moduleid = "$OpenBSD: src/usr.bin/file/apprentice.c,v 1.5 1998/07/10 15:05:13 mickey Exp $";
#endif	/* lint */

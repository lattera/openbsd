/*	$OpenBSD: src/usr.bin/file/apprentice.c,v 1.10 2000/06/30 16:00:13 millert Exp $	*/
...
#ifndef	lint
static char *moduleid = "$OpenBSD: src/usr.bin/file/apprentice.c,v 1.10 2000/06/30 16:00:13 millert Exp $";
#endif	/* lint */

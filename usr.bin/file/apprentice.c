/*	$OpenBSD: src/usr.bin/file/apprentice.c,v 1.14 2002/06/05 13:46:44 itojun Exp $	*/
...
#ifndef	lint
static char *moduleid = "$OpenBSD: src/usr.bin/file/apprentice.c,v 1.14 2002/06/05 13:46:44 itojun Exp $";
#endif	/* lint */

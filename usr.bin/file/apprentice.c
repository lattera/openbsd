/*	$OpenBSD: src/usr.bin/file/apprentice.c,v 1.7 1998/08/21 04:25:02 deraadt Exp $	*/
...
#ifndef	lint
static char *moduleid = "$OpenBSD: src/usr.bin/file/apprentice.c,v 1.7 1998/08/21 04:25:02 deraadt Exp $";
#endif	/* lint */

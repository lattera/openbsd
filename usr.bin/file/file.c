/*	$OpenBSD: src/usr.bin/file/file.c,v 1.7 1999/02/19 00:28:37 deraadt Exp $	*/
 ...
 */
#ifndef	lint
static char *moduleid = "$OpenBSD: src/usr.bin/file/file.c,v 1.7 1999/02/19 00:28:37 deraadt Exp $";
#endif	/* lint */

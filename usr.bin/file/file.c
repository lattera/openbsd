/*	$OpenBSD: src/usr.bin/file/file.c,v 1.10 2002/12/15 13:30:17 henning Exp $	*/
 ...
 */
#ifndef	lint
static char *moduleid = "$OpenBSD: src/usr.bin/file/file.c,v 1.10 2002/12/15 13:30:17 henning Exp $";
#endif	/* lint */

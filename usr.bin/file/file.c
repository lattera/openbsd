/*	$OpenBSD: src/usr.bin/file/file.c,v 1.4 1997/01/15 23:42:26 millert Exp $	*/
/*
 ...
 */
#ifndef	lint
static char *moduleid = "$OpenBSD: src/usr.bin/file/file.c,v 1.4 1997/01/15 23:42:26 millert Exp $";
#endif	/* lint */

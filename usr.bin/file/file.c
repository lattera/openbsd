/*	$OpenBSD: src/usr.bin/file/file.c,v 1.5 1997/02/09 23:58:22 millert Exp $	*/
 ...
 */
#ifndef	lint
static char *moduleid = "$OpenBSD: src/usr.bin/file/file.c,v 1.5 1997/02/09 23:58:22 millert Exp $";
#endif	/* lint */

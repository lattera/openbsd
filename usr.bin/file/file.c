/*	$OpenBSD: src/usr.bin/file/file.c,v 1.9 2002/11/29 00:27:03 millert Exp $	*/
 ...
 */
#ifndef	lint
static char *moduleid = "$OpenBSD: src/usr.bin/file/file.c,v 1.9 2002/11/29 00:27:03 millert Exp $";
#endif	/* lint */

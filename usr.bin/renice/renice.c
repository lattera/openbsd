/*	$OpenBSD: src/usr.bin/renice/renice.c,v 1.13 2008/12/08 21:23:10 millert Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/renice/renice.c,v 1.13 2008/12/08 21:23:10 millert Exp $";
#endif /* not lint */

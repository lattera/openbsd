/* $OpenBSD: src/usr.bin/rpcgen/rpc_main.c,v 1.14 2002/06/01 01:40:38 deraadt Exp $	 */
...
static char     cvsid[] = "$OpenBSD: src/usr.bin/rpcgen/rpc_main.c,v 1.14 2002/06/01 01:40:38 deraadt Exp $";
#endif

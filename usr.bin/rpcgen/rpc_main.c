/*	$OpenBSD: src/usr.bin/rpcgen/rpc_main.c,v 1.9 2001/11/24 19:17:47 deraadt Exp $	*/
...
static char cvsid[] = "$OpenBSD: src/usr.bin/rpcgen/rpc_main.c,v 1.9 2001/11/24 19:17:47 deraadt Exp $";
#endif

/*	$OpenBSD: src/usr.bin/rpcgen/rpc_main.c,v 1.8 2001/11/07 18:44:28 deraadt Exp $	*/
...
static char cvsid[] = "$OpenBSD: src/usr.bin/rpcgen/rpc_main.c,v 1.8 2001/11/07 18:44:28 deraadt Exp $";
#endif

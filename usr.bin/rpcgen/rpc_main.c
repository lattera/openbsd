/* $OpenBSD: src/usr.bin/rpcgen/rpc_main.c,v 1.15 2002/07/05 05:39:42 deraadt Exp $	 */
...
static char     cvsid[] = "$OpenBSD: src/usr.bin/rpcgen/rpc_main.c,v 1.15 2002/07/05 05:39:42 deraadt Exp $";
#endif

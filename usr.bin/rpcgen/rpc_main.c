/* $OpenBSD: src/usr.bin/rpcgen/rpc_main.c,v 1.13 2002/05/27 03:14:22 deraadt Exp $	 */
...
static char     cvsid[] = "$OpenBSD: src/usr.bin/rpcgen/rpc_main.c,v 1.13 2002/05/27 03:14:22 deraadt Exp $";
#endif

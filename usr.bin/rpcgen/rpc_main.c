/* $OpenBSD: src/usr.bin/rpcgen/rpc_main.c,v 1.20 2004/05/09 22:22:45 deraadt Exp $	 */
...
static char     cvsid[] = "$OpenBSD: src/usr.bin/rpcgen/rpc_main.c,v 1.20 2004/05/09 22:22:45 deraadt Exp $";
#endif

/*	$OpenBSD: src/usr.bin/rpcgen/rpc_main.c,v 1.5 2001/01/21 22:02:52 deraadt Exp $	*/
...
static char cvsid[] = "$OpenBSD: src/usr.bin/rpcgen/rpc_main.c,v 1.5 2001/01/21 22:02:52 deraadt Exp $";
#endif

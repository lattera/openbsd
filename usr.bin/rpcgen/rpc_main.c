/*	$OpenBSD: src/usr.bin/rpcgen/rpc_main.c,v 1.2 1996/03/27 19:32:51 niklas Exp $	*/
...
static char cvsid[] = "$OpenBSD: src/usr.bin/rpcgen/rpc_main.c,v 1.2 1996/03/27 19:32:51 niklas Exp $";
#endif

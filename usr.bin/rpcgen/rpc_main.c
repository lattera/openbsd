/*	$OpenBSD: src/usr.bin/rpcgen/rpc_main.c,v 1.7 2001/07/18 22:26:00 deraadt Exp $	*/
...
static char cvsid[] = "$OpenBSD: src/usr.bin/rpcgen/rpc_main.c,v 1.7 2001/07/18 22:26:00 deraadt Exp $";
#endif

/*	$OpenBSD: src/usr.bin/rpcgen/rpc_main.c,v 1.4 1999/12/04 21:58:31 deraadt Exp $	*/
...
static char cvsid[] = "$OpenBSD: src/usr.bin/rpcgen/rpc_main.c,v 1.4 1999/12/04 21:58:31 deraadt Exp $";
#endif

/*	$OpenBSD: src/usr.bin/rpcgen/rpc_main.c,v 1.10 2001/11/24 19:19:59 deraadt Exp $	*/
...
static char cvsid[] = "$OpenBSD: src/usr.bin/rpcgen/rpc_main.c,v 1.10 2001/11/24 19:19:59 deraadt Exp $";
#endif

/*	$OpenBSD: src/usr.bin/rpcgen/rpc_main.c,v 1.3 1997/10/11 21:10:41 deraadt Exp $	*/
...
static char cvsid[] = "$OpenBSD: src/usr.bin/rpcgen/rpc_main.c,v 1.3 1997/10/11 21:10:41 deraadt Exp $";
#endif

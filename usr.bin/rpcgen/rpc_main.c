/* $OpenBSD: src/usr.bin/rpcgen/rpc_main.c,v 1.12 2002/02/16 21:27:51 millert Exp $	 */
...
static char     cvsid[] = "$OpenBSD: src/usr.bin/rpcgen/rpc_main.c,v 1.12 2002/02/16 21:27:51 millert Exp $";
#endif

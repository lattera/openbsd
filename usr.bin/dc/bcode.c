/*	$OpenBSD: src/usr.bin/dc/bcode.c,v 1.14 2003/11/06 19:48:13 otto Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/dc/bcode.c,v 1.14 2003/11/06 19:48:13 otto Exp $";
#endif /* not lint */

/*	$OpenBSD: src/usr.bin/dc/bcode.c,v 1.33 2006/01/16 08:09:25 otto Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/dc/bcode.c,v 1.33 2006/01/16 08:09:25 otto Exp $";
#endif /* not lint */

/*	$OpenBSD: src/usr.bin/dc/bcode.c,v 1.25 2004/12/01 08:29:38 otto Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/dc/bcode.c,v 1.25 2004/12/01 08:29:38 otto Exp $";
#endif /* not lint */

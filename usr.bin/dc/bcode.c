/*	$OpenBSD: src/usr.bin/dc/bcode.c,v 1.32 2006/01/15 19:14:40 otto Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/dc/bcode.c,v 1.32 2006/01/15 19:14:40 otto Exp $";
#endif /* not lint */

/*	$OpenBSD: src/usr.bin/dc/bcode.c,v 1.18 2003/12/01 09:13:24 otto Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/dc/bcode.c,v 1.18 2003/12/01 09:13:24 otto Exp $";
#endif /* not lint */

/*	$OpenBSD: src/usr.bin/dc/bcode.c,v 1.16 2003/11/14 20:25:16 otto Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/dc/bcode.c,v 1.16 2003/11/14 20:25:16 otto Exp $";
#endif /* not lint */

/*	$OpenBSD: src/usr.bin/dc/bcode.c,v 1.22 2004/02/11 20:44:31 otto Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/dc/bcode.c,v 1.22 2004/02/11 20:44:31 otto Exp $";
#endif /* not lint */

/*	$OpenBSD: src/usr.bin/dc/bcode.c,v 1.11 2003/10/22 12:15:20 otto Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/dc/bcode.c,v 1.11 2003/10/22 12:15:20 otto Exp $";
#endif /* not lint */

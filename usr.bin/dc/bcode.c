/*	$OpenBSD: src/usr.bin/dc/bcode.c,v 1.20 2003/12/19 19:23:16 otto Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/dc/bcode.c,v 1.20 2003/12/19 19:23:16 otto Exp $";
#endif /* not lint */

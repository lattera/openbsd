/*	$OpenBSD: src/usr.bin/dc/bcode.c,v 1.23 2004/09/14 22:22:46 deraadt Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/dc/bcode.c,v 1.23 2004/09/14 22:22:46 deraadt Exp $";
#endif /* not lint */

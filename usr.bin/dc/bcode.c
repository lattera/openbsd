/*	$OpenBSD: src/usr.bin/dc/bcode.c,v 1.26 2004/12/01 08:40:12 otto Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/dc/bcode.c,v 1.26 2004/12/01 08:40:12 otto Exp $";
#endif /* not lint */

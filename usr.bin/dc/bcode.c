/*	$OpenBSD: src/usr.bin/dc/bcode.c,v 1.21 2004/01/20 21:41:20 deraadt Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/dc/bcode.c,v 1.21 2004/01/20 21:41:20 deraadt Exp $";
#endif /* not lint */

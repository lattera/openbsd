/*	$OpenBSD: src/usr.bin/dc/inout.c,v 1.3 2003/09/19 19:06:29 deraadt Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/dc/inout.c,v 1.3 2003/09/19 19:06:29 deraadt Exp $";
#endif /* not lint */

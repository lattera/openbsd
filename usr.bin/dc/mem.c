/*	$OpenBSD: src/usr.bin/dc/mem.c,v 1.4 2004/07/11 06:41:48 otto Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/dc/mem.c,v 1.4 2004/07/11 06:41:48 otto Exp $";
#endif /* not lint */

/*	$OpenBSD: src/usr.bin/dc/mem.c,v 1.2 2003/09/28 19:17:21 otto Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/dc/mem.c,v 1.2 2003/09/28 19:17:21 otto Exp $";
#endif /* not lint */

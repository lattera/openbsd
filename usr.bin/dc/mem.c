/*	$OpenBSD: src/usr.bin/dc/mem.c,v 1.3 2003/10/18 20:34:26 otto Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/dc/mem.c,v 1.3 2003/10/18 20:34:26 otto Exp $";
#endif /* not lint */

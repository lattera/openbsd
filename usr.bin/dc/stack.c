/*	$OpenBSD: src/usr.bin/dc/stack.c,v 1.6 2003/11/26 19:30:52 otto Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/dc/stack.c,v 1.6 2003/11/26 19:30:52 otto Exp $";
#endif /* not lint */

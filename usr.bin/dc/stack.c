/*	$OpenBSD: src/usr.bin/dc/stack.c,v 1.4 2003/10/18 20:34:26 otto Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/dc/stack.c,v 1.4 2003/10/18 20:34:26 otto Exp $";
#endif /* not lint */

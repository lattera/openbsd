/*	$OpenBSD: src/usr.bin/dc/dc.c,v 1.10 2007/07/29 17:12:18 sobrado Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/dc/dc.c,v 1.10 2007/07/29 17:12:18 sobrado Exp $";
#endif /* not lint */

/*	$OpenBSD: src/usr.bin/rpcinfo/rpcinfo.c,v 1.5 2000/07/31 16:55:37 deraadt Exp $	*/

#ifndef lint
/*static char sccsid[] = "from: @(#)rpcinfo.c 1.22 87/08/12 SMI";*/
/*static char sccsid[] = "from: @(#)rpcinfo.c	2.2 88/08/11 4.0 RPCSRC";*/
static char rcsid[] = "$OpenBSD: src/usr.bin/rpcinfo/rpcinfo.c,v 1.5 2000/07/31 16:55:37 deraadt Exp $";
#endif

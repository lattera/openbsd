/*	$OpenBSD: src/usr.bin/patch/pch.c,v 1.25 2003/07/28 18:35:36 otto Exp $	*/

#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/patch/pch.c,v 1.25 2003/07/28 18:35:36 otto Exp $";
#endif /* not lint */

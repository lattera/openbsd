/* $OpenBSD: src/usr.bin/patch/pch.c,v 1.19 2003/07/21 14:30:31 deraadt Exp $	 */

#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/patch/pch.c,v 1.19 2003/07/21 14:30:31 deraadt Exp $";
#endif /* not lint */

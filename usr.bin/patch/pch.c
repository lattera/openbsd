/*	$OpenBSD: src/usr.bin/patch/pch.c,v 1.13 2003/04/08 00:18:31 deraadt Exp $	*/

#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/patch/pch.c,v 1.13 2003/04/08 00:18:31 deraadt Exp $";
#endif /* not lint */

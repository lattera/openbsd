/*	$OpenBSD: src/usr.bin/patch/pch.c,v 1.14 2003/07/16 18:09:20 otto Exp $	*/

#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/patch/pch.c,v 1.14 2003/07/16 18:09:20 otto Exp $";
#endif /* not lint */

/*	$OpenBSD: src/usr.bin/patch/pch.c,v 1.4 1996/07/01 20:40:10 deraadt Exp $	*/

#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/patch/pch.c,v 1.4 1996/07/01 20:40:10 deraadt Exp $";
#endif /* not lint */

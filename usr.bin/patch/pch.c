/*	$OpenBSD: src/usr.bin/patch/pch.c,v 1.26 2003/07/28 19:15:34 deraadt Exp $	*/

#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/patch/pch.c,v 1.26 2003/07/28 19:15:34 deraadt Exp $";
#endif /* not lint */

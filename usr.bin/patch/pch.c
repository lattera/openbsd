/*	$OpenBSD: src/usr.bin/patch/pch.c,v 1.27 2003/07/29 20:10:17 millert Exp $	*/

#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/patch/pch.c,v 1.27 2003/07/29 20:10:17 millert Exp $";
#endif /* not lint */

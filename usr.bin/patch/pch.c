/* $OpenBSD: src/usr.bin/patch/pch.c,v 1.18 2003/07/21 14:27:35 deraadt Exp $	 */

#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/patch/pch.c,v 1.18 2003/07/21 14:27:35 deraadt Exp $";
#endif /* not lint */

/*	$OpenBSD: src/usr.bin/patch/pch.c,v 1.9 1998/11/25 00:30:26 espie Exp $	*/

#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/patch/pch.c,v 1.9 1998/11/25 00:30:26 espie Exp $";
#endif /* not lint */

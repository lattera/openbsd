/*	$OpenBSD: src/usr.bin/patch/util.c,v 1.23 2003/07/30 15:47:54 millert Exp $	*/

#ifndef lint
static const char     rcsid[] = "$OpenBSD: src/usr.bin/patch/util.c,v 1.23 2003/07/30 15:47:54 millert Exp $";
#endif /* not lint */

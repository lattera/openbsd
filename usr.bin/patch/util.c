/* $OpenBSD: src/usr.bin/patch/util.c,v 1.13 2003/07/21 14:00:41 deraadt Exp $	 */

#ifndef lint
static char     rcsid[] = "$OpenBSD: src/usr.bin/patch/util.c,v 1.13 2003/07/21 14:00:41 deraadt Exp $";
#endif				/* not lint */

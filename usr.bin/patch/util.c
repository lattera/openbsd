/*	$OpenBSD: src/usr.bin/patch/util.c,v 1.6 1999/01/11 00:16:32 marc Exp $	*/

#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/patch/util.c,v 1.6 1999/01/11 00:16:32 marc Exp $";
#endif /* not lint */

/*	$OpenBSD: src/usr.bin/patch/util.c,v 1.3 1996/09/24 04:19:30 millert Exp $	*/

#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/patch/util.c,v 1.3 1996/09/24 04:19:30 millert Exp $";
#endif /* not lint */

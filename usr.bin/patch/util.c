/*	$OpenBSD: src/usr.bin/patch/util.c,v 1.21 2003/07/28 19:05:26 millert Exp $	*/

#ifndef lint
static const char     rcsid[] = "$OpenBSD: src/usr.bin/patch/util.c,v 1.21 2003/07/28 19:05:26 millert Exp $";
#endif /* not lint */

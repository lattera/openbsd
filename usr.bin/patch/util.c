/*	$OpenBSD: src/usr.bin/patch/util.c,v 1.15 2003/07/21 14:32:21 deraadt Exp $	*/

#ifndef lint
static char     rcsid[] = "$OpenBSD: src/usr.bin/patch/util.c,v 1.15 2003/07/21 14:32:21 deraadt Exp $";
#endif				/* not lint */

/*	$OpenBSD: src/usr.bin/patch/util.c,v 1.11 2003/04/08 00:18:31 deraadt Exp $	*/

#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/patch/util.c,v 1.11 2003/04/08 00:18:31 deraadt Exp $";
#endif /* not lint */

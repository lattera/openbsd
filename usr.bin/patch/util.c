/*	$OpenBSD: src/usr.bin/patch/util.c,v 1.10 2003/04/05 17:17:53 deraadt Exp $	*/

#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/patch/util.c,v 1.10 2003/04/05 17:17:53 deraadt Exp $";
#endif /* not lint */

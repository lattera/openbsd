/*	$OpenBSD: src/usr.bin/patch/util.c,v 1.18 2003/07/25 02:12:45 millert Exp $	*/

#ifndef lint
static const char     rcsid[] = "$OpenBSD: src/usr.bin/patch/util.c,v 1.18 2003/07/25 02:12:45 millert Exp $";
#endif /* not lint */

/*	$OpenBSD: src/usr.bin/patch/backupfile.c,v 1.8 2003/04/05 17:17:53 deraadt Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/patch/backupfile.c,v 1.8 2003/04/05 17:17:53 deraadt Exp $";
#endif /* not lint */

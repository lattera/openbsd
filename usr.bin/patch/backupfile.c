/*	$OpenBSD: src/usr.bin/patch/backupfile.c,v 1.14 2003/07/22 17:52:20 deraadt Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/patch/backupfile.c,v 1.14 2003/07/22 17:52:20 deraadt Exp $";
#endif /* not lint */

/*	$OpenBSD: src/usr.bin/patch/backupfile.c,v 1.18 2004/08/05 21:47:24 deraadt Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/patch/backupfile.c,v 1.18 2004/08/05 21:47:24 deraadt Exp $";
#endif /* not lint */

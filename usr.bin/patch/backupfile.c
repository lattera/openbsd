/*	$OpenBSD: src/usr.bin/patch/backupfile.c,v 1.13 2003/07/22 17:18:49 otto Exp $	*/
...
#ifndef lint
static const char     rcsid[] = "$OpenBSD: src/usr.bin/patch/backupfile.c,v 1.13 2003/07/22 17:18:49 otto Exp $";
#endif				/* not lint */

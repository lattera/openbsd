/*	$OpenBSD: src/usr.bin/patch/backupfile.c,v 1.12 2003/07/21 14:32:21 deraadt Exp $	*/
...
#ifndef lint
static char     rcsid[] = "$OpenBSD: src/usr.bin/patch/backupfile.c,v 1.12 2003/07/21 14:32:21 deraadt Exp $";
#endif				/* not lint */

/* $OpenBSD: src/usr.bin/patch/backupfile.c,v 1.11 2003/07/21 14:00:41 deraadt Exp $	 */
...
#ifndef lint
static char     rcsid[] = "$OpenBSD: src/usr.bin/patch/backupfile.c,v 1.11 2003/07/21 14:00:41 deraadt Exp $";
#endif				/* not lint */

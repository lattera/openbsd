/*	$OpenBSD: src/usr.bin/patch/backupfile.c,v 1.16 2003/07/28 18:35:36 otto Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/patch/backupfile.c,v 1.16 2003/07/28 18:35:36 otto Exp $";
#endif /* not lint */

/*	$OpenBSD: src/usr.bin/patch/patch.c,v 1.11 1998/11/25 00:30:26 espie Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/patch/patch.c,v 1.11 1998/11/25 00:30:26 espie Exp $";
#endif /* not lint */

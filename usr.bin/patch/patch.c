/*	$OpenBSD: src/usr.bin/patch/patch.c,v 1.8 1996/09/24 04:19:28 millert Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/patch/patch.c,v 1.8 1996/09/24 04:19:28 millert Exp $";
#endif /* not lint */

/*	$OpenBSD: src/usr.bin/patch/patch.c,v 1.7 1996/09/24 02:58:52 millert Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/patch/patch.c,v 1.7 1996/09/24 02:58:52 millert Exp $";
#endif /* not lint */

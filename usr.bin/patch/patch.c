/*	$OpenBSD: src/usr.bin/patch/patch.c,v 1.13 1999/12/04 01:01:06 provos Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/patch/patch.c,v 1.13 1999/12/04 01:01:06 provos Exp $";
#endif /* not lint */

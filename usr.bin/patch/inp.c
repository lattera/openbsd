/*	$OpenBSD: src/usr.bin/patch/inp.c,v 1.6 1997/09/22 05:45:26 millert Exp $	*/

#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/patch/inp.c,v 1.6 1997/09/22 05:45:26 millert Exp $";
#endif /* not lint */

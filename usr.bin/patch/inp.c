/*	$OpenBSD: src/usr.bin/patch/inp.c,v 1.7 1998/11/25 00:30:25 espie Exp $	*/

#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/patch/inp.c,v 1.7 1998/11/25 00:30:25 espie Exp $";
#endif /* not lint */

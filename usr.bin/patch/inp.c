/* $OpenBSD: src/usr.bin/patch/inp.c,v 1.13 2003/07/21 14:30:31 deraadt Exp $	 */

#ifndef lint
static char     rcsid[] = "$OpenBSD: src/usr.bin/patch/inp.c,v 1.13 2003/07/21 14:30:31 deraadt Exp $";
#endif				/* not lint */

/*	$OpenBSD: src/usr.bin/patch/inp.c,v 1.15 2003/07/21 21:01:45 otto Exp $	*/

#ifndef lint
static char     rcsid[] = "$OpenBSD: src/usr.bin/patch/inp.c,v 1.15 2003/07/21 21:01:45 otto Exp $";
#endif				/* not lint */

/*	$OpenBSD: src/usr.bin/patch/inp.c,v 1.24 2003/08/05 18:20:33 deraadt Exp $	*/

#ifndef lint
static const char     rcsid[] = "$OpenBSD: src/usr.bin/patch/inp.c,v 1.24 2003/08/05 18:20:33 deraadt Exp $";
#endif /* not lint */

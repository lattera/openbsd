/*	$OpenBSD: src/usr.bin/patch/inp.c,v 1.20 2003/07/28 19:15:34 deraadt Exp $	*/

#ifndef lint
static const char     rcsid[] = "$OpenBSD: src/usr.bin/patch/inp.c,v 1.20 2003/07/28 19:15:34 deraadt Exp $";
#endif /* not lint */

/*	$OpenBSD: src/usr.bin/patch/inp.c,v 1.23 2003/08/05 18:13:43 otto Exp $	*/

#ifndef lint
static const char     rcsid[] = "$OpenBSD: src/usr.bin/patch/inp.c,v 1.23 2003/08/05 18:13:43 otto Exp $";
#endif /* not lint */

/*	$OpenBSD: src/usr.bin/patch/inp.c,v 1.9 2002/07/04 04:22:48 deraadt Exp $	*/

#ifndef lint
static char rcsid[] = "$OpenBSD: src/usr.bin/patch/inp.c,v 1.9 2002/07/04 04:22:48 deraadt Exp $";
#endif /* not lint */

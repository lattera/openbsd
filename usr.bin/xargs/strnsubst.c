/*	$OpenBSD: src/usr.bin/xargs/strnsubst.c,v 1.4 2005/12/01 05:52:20 cloder Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/xargs/strnsubst.c,v 1.4 2005/12/01 05:52:20 cloder Exp $";
#endif /* not lint */

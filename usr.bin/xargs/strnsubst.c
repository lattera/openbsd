/*	$OpenBSD: src/usr.bin/xargs/strnsubst.c,v 1.1 2003/06/12 01:09:23 millert Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/xargs/strnsubst.c,v 1.1 2003/06/12 01:09:23 millert Exp $";
#endif /* not lint */

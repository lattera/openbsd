/*	$OpenBSD: src/usr.bin/xargs/strnsubst.c,v 1.3 2005/11/01 04:52:58 deraadt Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/xargs/strnsubst.c,v 1.3 2005/11/01 04:52:58 deraadt Exp $";
#endif /* not lint */

/*	$OpenBSD: src/usr.bin/xargs/strnsubst.c,v 1.2 2003/06/12 03:23:22 millert Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/usr.bin/xargs/strnsubst.c,v 1.2 2003/06/12 03:23:22 millert Exp $";
#endif /* not lint */

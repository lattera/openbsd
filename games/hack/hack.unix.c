/*	$OpenBSD: src/games/hack/hack.unix.c,v 1.9 2002/12/06 21:48:51 millert Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/games/hack/hack.unix.c,v 1.9 2002/12/06 21:48:51 millert Exp $";
#endif /* not lint */

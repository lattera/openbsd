/*	$OpenBSD: src/games/hack/hack.main.c,v 1.8 2002/06/23 03:01:13 deraadt Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/games/hack/hack.main.c,v 1.8 2002/06/23 03:01:13 deraadt Exp $";
#endif /* not lint */

/*	$OpenBSD: src/games/hack/hack.lev.c,v 1.3 2001/01/28 23:41:44 niklas Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/games/hack/hack.lev.c,v 1.3 2001/01/28 23:41:44 niklas Exp $";
#endif /* not lint */

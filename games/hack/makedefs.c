/*	$OpenBSD: src/games/hack/makedefs.c,v 1.3 2001/01/28 23:41:46 niklas Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/games/hack/makedefs.c,v 1.3 2001/01/28 23:41:46 niklas Exp $";
#endif /* not lint */

/*	$OpenBSD: src/games/hack/hack.dog.c,v 1.3 2001/01/28 23:41:43 niklas Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/games/hack/hack.dog.c,v 1.3 2001/01/28 23:41:43 niklas Exp $";
#endif /* not lint */

/*	$OpenBSD: src/games/hack/hack.monst.c,v 1.2 2001/01/28 23:41:44 niklas Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/games/hack/hack.monst.c,v 1.2 2001/01/28 23:41:44 niklas Exp $";
#endif /* not lint */

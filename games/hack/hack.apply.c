/*	$OpenBSD: src/games/hack/hack.apply.c,v 1.2 2001/01/28 23:41:43 niklas Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/games/hack/hack.apply.c,v 1.2 2001/01/28 23:41:43 niklas Exp $";
#endif /* not lint */

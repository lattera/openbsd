/*	$OpenBSD: src/games/hack/hack.u_init.c,v 1.4 2001/08/06 22:59:13 pjanzen Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/games/hack/hack.u_init.c,v 1.4 2001/08/06 22:59:13 pjanzen Exp $";
#endif /* not lint */

/*	$OpenBSD: src/games/larn/Attic/scores.c,v 1.6 1999/03/27 03:45:50 pjanzen Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/games/larn/Attic/scores.c,v 1.6 1999/03/27 03:45:50 pjanzen Exp $";
#endif				/* not lint */

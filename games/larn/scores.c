/*	$OpenBSD: src/games/larn/Attic/scores.c,v 1.7 2000/06/29 07:55:42 pjanzen Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/games/larn/Attic/scores.c,v 1.7 2000/06/29 07:55:42 pjanzen Exp $";
#endif				/* not lint */

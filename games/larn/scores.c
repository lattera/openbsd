/*	$OpenBSD: src/games/larn/Attic/scores.c,v 1.5 1998/09/15 05:12:33 pjanzen Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/games/larn/Attic/scores.c,v 1.5 1998/09/15 05:12:33 pjanzen Exp $";
#endif				/* not lint */

/*	$OpenBSD: src/games/larn/Attic/config.c,v 1.4 2000/06/29 07:55:40 pjanzen Exp $	*/
...
#include <sys/cdefs.h>
#ifndef lint
static char rcsid[] = "$OpenBSD: src/games/larn/Attic/config.c,v 1.4 2000/06/29 07:55:40 pjanzen Exp $";
#endif /* not lint */

/*	$OpenBSD: src/games/larn/Attic/config.c,v 1.3 1998/09/15 05:12:31 pjanzen Exp $	*/
...
#include <sys/cdefs.h>
#ifndef lint
static char rcsid[] = "$OpenBSD: src/games/larn/Attic/config.c,v 1.3 1998/09/15 05:12:31 pjanzen Exp $";
#endif /* not lint */

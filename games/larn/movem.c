/*	$OpenBSD: src/games/larn/Attic/movem.c,v 1.4 1999/03/12 08:45:45 pjanzen Exp $	*/
 ...
 */
#ifndef lint
static char rcsid[] = "$OpenBSD: src/games/larn/Attic/movem.c,v 1.4 1999/03/12 08:45:45 pjanzen Exp $";
#endif				/* not lint */

/*	$OpenBSD: src/games/larn/Attic/movem.c,v 1.3 1998/09/15 05:12:32 pjanzen Exp $	*/
 ...
 */
#ifndef lint
static char rcsid[] = "$OpenBSD: src/games/larn/Attic/movem.c,v 1.3 1998/09/15 05:12:32 pjanzen Exp $";
#endif				/* not lint */

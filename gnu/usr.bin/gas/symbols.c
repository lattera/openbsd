/*	$OpenBSD: src/gnu/usr.bin/gas/Attic/symbols.c,v 1.2 1998/02/15 18:49:01 niklas Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/gnu/usr.bin/gas/Attic/symbols.c,v 1.2 1998/02/15 18:49:01 niklas Exp $";
#endif

/*	$OpenBSD: src/gnu/usr.bin/gas/Attic/flo-const.c,v 1.2 1998/02/15 18:48:46 niklas Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/gnu/usr.bin/gas/Attic/flo-const.c,v 1.2 1998/02/15 18:48:46 niklas Exp $";
#endif

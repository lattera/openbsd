/*	$OpenBSD: src/gnu/usr.bin/gas/Attic/write.c,v 1.2 1996/04/23 00:15:55 niklas Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/gnu/usr.bin/gas/Attic/write.c,v 1.2 1996/04/23 00:15:55 niklas Exp $";
#endif

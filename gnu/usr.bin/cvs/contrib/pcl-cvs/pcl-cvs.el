...
;;;
;;;#ident "@(#)cvs/contrib/pcl-cvs:$Name:  $:$Id: pcl-cvs.el,v 1.23 1996/01/23 18:05:22 woods Exp $"
;;;
...
ERR-BUF should be 'STDOUT or 'STDERR."
  ...
  (let* ((stdout (save-excursion (set-buffer stdout-buffer) (buffer-string)))
    ...
    (insert "CVS Version: "
	    "@(#)cvs/contrib/pcl-cvs:$Name:  $:$Id: pcl-cvs.el,v 1.23 1996/01/23 18:05:22 woods Exp $\n\n")

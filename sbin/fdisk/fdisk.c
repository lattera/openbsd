/*	$OpenBSD: src/sbin/fdisk/fdisk.c,v 1.6 1996/09/27 15:27:03 deraadt Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/sbin/fdisk/fdisk.c,v 1.6 1996/09/27 15:27:03 deraadt Exp $";
#endif /* not lint */

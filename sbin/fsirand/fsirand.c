/*	$OpenBSD: src/sbin/fsirand/fsirand.c,v 1.20 2003/09/24 20:40:19 deraadt Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/sbin/fsirand/fsirand.c,v 1.20 2003/09/24 20:40:19 deraadt Exp $";
#endif /* not lint */

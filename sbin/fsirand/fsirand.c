/*	$OpenBSD: src/sbin/fsirand/fsirand.c,v 1.22 2004/09/14 22:11:35 deraadt Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/sbin/fsirand/fsirand.c,v 1.22 2004/09/14 22:11:35 deraadt Exp $";
#endif /* not lint */

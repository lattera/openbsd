/*	$OpenBSD: src/sbin/fsirand/fsirand.c,v 1.17 2003/06/03 01:52:40 millert Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/sbin/fsirand/fsirand.c,v 1.17 2003/06/03 01:52:40 millert Exp $";
#endif /* not lint */

/*	$OpenBSD: src/sbin/fsirand/fsirand.c,v 1.19 2003/08/25 23:28:15 tedu Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/sbin/fsirand/fsirand.c,v 1.19 2003/08/25 23:28:15 tedu Exp $";
#endif /* not lint */

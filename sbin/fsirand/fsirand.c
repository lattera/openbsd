/*	$OpenBSD: src/sbin/fsirand/fsirand.c,v 1.23 2007/02/20 13:55:17 jmc Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/sbin/fsirand/fsirand.c,v 1.23 2007/02/20 13:55:17 jmc Exp $";
#endif /* not lint */

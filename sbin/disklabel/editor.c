/*	$OpenBSD: src/sbin/disklabel/editor.c,v 1.201 2009/04/30 06:56:34 deraadt Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/sbin/disklabel/editor.c,v 1.201 2009/04/30 06:56:34 deraadt Exp $";
#endif /* not lint */

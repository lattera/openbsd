/*	$OpenBSD: src/sbin/disklabel/editor.c,v 1.136 2008/01/01 16:22:27 krw Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/sbin/disklabel/editor.c,v 1.136 2008/01/01 16:22:27 krw Exp $";
#endif /* not lint */

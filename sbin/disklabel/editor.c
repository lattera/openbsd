/*	$OpenBSD: src/sbin/disklabel/editor.c,v 1.94 2004/08/03 09:30:12 otto Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/sbin/disklabel/editor.c,v 1.94 2004/08/03 09:30:12 otto Exp $";
#endif /* not lint */

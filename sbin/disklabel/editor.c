/*	$OpenBSD: src/sbin/disklabel/editor.c,v 1.181 2009/03/28 17:50:05 deraadt Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/sbin/disklabel/editor.c,v 1.181 2009/03/28 17:50:05 deraadt Exp $";
#endif /* not lint */

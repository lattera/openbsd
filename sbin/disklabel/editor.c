/*	$OpenBSD: src/sbin/disklabel/editor.c,v 1.197 2009/04/26 20:05:30 deraadt Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/sbin/disklabel/editor.c,v 1.197 2009/04/26 20:05:30 deraadt Exp $";
#endif /* not lint */

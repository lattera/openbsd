/*	$OpenBSD: src/sbin/disklabel/editor.c,v 1.111 2007/04/26 23:20:41 deraadt Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/sbin/disklabel/editor.c,v 1.111 2007/04/26 23:20:41 deraadt Exp $";
#endif /* not lint */

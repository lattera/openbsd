/*	$OpenBSD: src/sbin/disklabel/editor.c,v 1.91 2003/09/24 20:40:19 deraadt Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/sbin/disklabel/editor.c,v 1.91 2003/09/24 20:40:19 deraadt Exp $";
#endif /* not lint */

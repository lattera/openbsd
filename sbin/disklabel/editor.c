/*	$OpenBSD: src/sbin/disklabel/editor.c,v 1.153 2008/01/12 18:15:22 krw Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/sbin/disklabel/editor.c,v 1.153 2008/01/12 18:15:22 krw Exp $";
#endif /* not lint */

/*	$OpenBSD: src/sbin/disklabel/editor.c,v 1.150 2008/01/10 04:00:09 krw Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/sbin/disklabel/editor.c,v 1.150 2008/01/10 04:00:09 krw Exp $";
#endif /* not lint */

/*	$OpenBSD: src/sbin/disklabel/editor.c,v 1.159 2008/01/16 23:00:21 chl Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/sbin/disklabel/editor.c,v 1.159 2008/01/16 23:00:21 chl Exp $";
#endif /* not lint */

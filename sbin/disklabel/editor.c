/*	$OpenBSD: src/sbin/disklabel/editor.c,v 1.98 2004/12/11 07:28:05 otto Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/sbin/disklabel/editor.c,v 1.98 2004/12/11 07:28:05 otto Exp $";
#endif /* not lint */

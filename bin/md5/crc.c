/*	$OpenBSD: src/bin/md5/crc.c,v 1.2 2004/05/10 19:48:07 deraadt Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/bin/md5/crc.c,v 1.2 2004/05/10 19:48:07 deraadt Exp $";
#endif /* not lint */

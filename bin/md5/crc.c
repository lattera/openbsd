/*	$OpenBSD: src/bin/md5/crc.c,v 1.1 2004/05/02 17:53:29 millert Exp $	*/
...
#ifndef lint
static const char rcsid[] = "$OpenBSD: src/bin/md5/crc.c,v 1.1 2004/05/02 17:53:29 millert Exp $";
#endif /* not lint */

/*	$OpenBSD: src/bin/test/test.c,v 1.4 1997/06/18 20:34:45 kstailey Exp $	*/
...
#ifndef lint
static char rcsid[] = "$OpenBSD: src/bin/test/test.c,v 1.4 1997/06/18 20:34:45 kstailey Exp $";
#endif

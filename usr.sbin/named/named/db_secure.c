/*	$OpenBSD: src/usr.sbin/named/named/Attic/db_secure.c,v 1.3 1998/05/22 00:47:36 millert Exp $	*/

#ifndef LINT
#if 0
static char rcsid[] = "$From: db_secure.c,v 8.6 1996/05/17 09:10:46 vixie Exp $";
#else
static char rcsid[] = "$OpenBSD: src/usr.sbin/named/named/Attic/db_secure.c,v 1.3 1998/05/22 00:47:36 millert Exp $";
#endif
#endif

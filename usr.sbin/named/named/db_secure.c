/*	$OpenBSD: src/usr.sbin/named/named/Attic/db_secure.c,v 1.4 2002/06/09 01:58:54 kjell Exp $	*/

#ifndef LINT
#if 0
static char rcsid[] = "$From: db_secure.c,v 8.6 1996/05/17 09:10:46 vixie Exp $";
#else
static char rcsid[] = "$OpenBSD: src/usr.sbin/named/named/Attic/db_secure.c,v 1.4 2002/06/09 01:58:54 kjell Exp $";
#endif
#endif

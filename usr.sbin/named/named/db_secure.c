/*	$OpenBSD: src/usr.sbin/named/named/Attic/db_secure.c,v 1.2 1997/03/12 10:42:25 downsj Exp $	*/

#ifndef LINT
#if 0
static char rcsid[] = "$From: db_secure.c,v 8.6 1996/05/17 09:10:46 vixie Exp $";
#else
static char rcsid[] = "$OpenBSD: src/usr.sbin/named/named/Attic/db_secure.c,v 1.2 1997/03/12 10:42:25 downsj Exp $";
#endif
#endif

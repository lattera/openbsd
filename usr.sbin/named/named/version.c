/*	$OpenBSD: src/usr.sbin/named/named/Attic/version.c,v 1.4 1998/05/22 07:09:22 millert Exp $	*/
...
#else
char rcsid[] = "$OpenBSD: src/usr.sbin/named/named/Attic/version.c,v 1.4 1998/05/22 07:09:22 millert Exp $";
#endif
#endif /* not lint */

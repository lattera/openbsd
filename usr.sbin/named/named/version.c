/*	$OpenBSD: src/usr.sbin/named/named/Attic/version.c,v 1.3 1998/05/22 00:47:50 millert Exp $	*/
...
#else
char rcsid[] = "$OpenBSD: src/usr.sbin/named/named/Attic/version.c,v 1.3 1998/05/22 00:47:50 millert Exp $";
#endif
#endif /* not lint */

/*	$OpenBSD: src/usr.sbin/named/named/Attic/version.c,v 1.2 1997/03/12 10:42:39 downsj Exp $	*/
...
#else
char rcsid[] = "$OpenBSD: src/usr.sbin/named/named/Attic/version.c,v 1.2 1997/03/12 10:42:39 downsj Exp $";
#endif
#endif /* not lint */

/*	$OpenBSD: src/usr.sbin/named/named/Attic/version.c,v 1.5 2001/01/30 20:56:10 niklas Exp $	*/
...
#else
char rcsid[] = "$OpenBSD: src/usr.sbin/named/named/Attic/version.c,v 1.5 2001/01/30 20:56:10 niklas Exp $";
#endif
#endif /* not lint */

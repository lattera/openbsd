/*	$OpenBSD: src/usr.sbin/named/named/Attic/Version.c,v 1.2 1997/03/12 10:42:20 downsj Exp $	*/
...
#else
char rcsid[] = "$OpenBSD: src/usr.sbin/named/named/Attic/Version.c,v 1.2 1997/03/12 10:42:20 downsj Exp $";
#endif
#endif /* not lint */

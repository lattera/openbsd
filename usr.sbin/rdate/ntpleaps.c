/*	$OpenBSD: src/usr.sbin/rdate/ntpleaps.c,v 1.3 2002/07/31 12:48:46 jakob Exp $	*/
...
static const char RCSId[] = "$OpenBSD: src/usr.sbin/rdate/ntpleaps.c,v 1.3 2002/07/31 12:48:46 jakob Exp $";

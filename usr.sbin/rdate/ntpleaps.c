/*	$OpenBSD: src/usr.sbin/rdate/ntpleaps.c,v 1.4 2002/08/01 06:26:57 jakob Exp $	*/
...
static const char RCSId[] = "$OpenBSD: src/usr.sbin/rdate/ntpleaps.c,v 1.4 2002/08/01 06:26:57 jakob Exp $";

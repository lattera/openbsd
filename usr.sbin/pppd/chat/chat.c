/*	$OpenBSD: src/usr.sbin/pppd/chat/chat.c,v 1.6 1998/01/17 20:30:33 millert Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/usr.sbin/pppd/chat/chat.c,v 1.6 1998/01/17 20:30:33 millert Exp $";
#endif
#endif

/*	$OpenBSD: src/usr.sbin/pppd/chat/chat.c,v 1.22 2004/02/26 17:46:24 deraadt Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/usr.sbin/pppd/chat/chat.c,v 1.22 2004/02/26 17:46:24 deraadt Exp $";
#endif
#endif

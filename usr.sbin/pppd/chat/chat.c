/*	$OpenBSD: src/usr.sbin/pppd/chat/chat.c,v 1.9 1998/09/12 14:06:52 provos Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/usr.sbin/pppd/chat/chat.c,v 1.9 1998/09/12 14:06:52 provos Exp $";
#endif
#endif

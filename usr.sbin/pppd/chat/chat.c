/*	$OpenBSD: src/usr.sbin/pppd/chat/chat.c,v 1.25 2009/08/08 14:09:34 sobrado Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/usr.sbin/pppd/chat/chat.c,v 1.25 2009/08/08 14:09:34 sobrado Exp $";
#endif
#endif

/*	$OpenBSD: src/usr.sbin/pppd/chat/chat.c,v 1.8 1998/08/04 17:50:58 millert Exp $	*/
...
#else
static char rcsid[] = "$OpenBSD: src/usr.sbin/pppd/chat/chat.c,v 1.8 1998/08/04 17:50:58 millert Exp $";
#endif
#endif

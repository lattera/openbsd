/*	$OpenBSD: src/usr.sbin/cron/env.c,v 1.12 2002/07/09 18:59:12 millert Exp $	*/
...
static char const rcsid[] = "$OpenBSD: src/usr.sbin/cron/env.c,v 1.12 2002/07/09 18:59:12 millert Exp $";
#endif

/*	$OpenBSD: src/usr.sbin/cron/env.c,v 1.8 2001/02/18 19:48:34 millert Exp $	*/
...
static char rcsid[] = "$OpenBSD: src/usr.sbin/cron/env.c,v 1.8 2001/02/18 19:48:34 millert Exp $";
#endif

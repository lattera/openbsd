/*	$OpenBSD: src/usr.sbin/cron/env.c,v 1.9 2001/02/18 20:17:20 millert Exp $	*/
...
static char rcsid[] = "$OpenBSD: src/usr.sbin/cron/env.c,v 1.9 2001/02/18 20:17:20 millert Exp $";
#endif

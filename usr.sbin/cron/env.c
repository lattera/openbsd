/*	$OpenBSD: src/usr.sbin/cron/env.c,v 1.11 2002/07/08 23:42:17 millert Exp $	*/
...
static char const rcsid[] = "$OpenBSD: src/usr.sbin/cron/env.c,v 1.11 2002/07/08 23:42:17 millert Exp $";
#endif

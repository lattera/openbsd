/*	$OpenBSD: src/usr.sbin/cron/env.c,v 1.16 2004/06/17 22:11:55 millert Exp $	*/
...
static char const rcsid[] = "$OpenBSD: src/usr.sbin/cron/env.c,v 1.16 2004/06/17 22:11:55 millert Exp $";
#endif

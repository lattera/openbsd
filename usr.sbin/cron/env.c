/*	$OpenBSD: src/usr.sbin/cron/env.c,v 1.15 2003/02/21 16:47:29 millert Exp $	*/
...
static char const rcsid[] = "$OpenBSD: src/usr.sbin/cron/env.c,v 1.15 2003/02/21 16:47:29 millert Exp $";
#endif

/*	$OpenBSD: src/usr.sbin/cron/env.c,v 1.20 2007/09/10 14:29:53 tobias Exp $	*/
...
static char const rcsid[] = "$OpenBSD: src/usr.sbin/cron/env.c,v 1.20 2007/09/10 14:29:53 tobias Exp $";
#endif

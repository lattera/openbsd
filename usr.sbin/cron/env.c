/*	$OpenBSD: src/usr.sbin/cron/env.c,v 1.21 2008/02/29 23:33:29 deraadt Exp $	*/
...
static char const rcsid[] = "$OpenBSD: src/usr.sbin/cron/env.c,v 1.21 2008/02/29 23:33:29 deraadt Exp $";
#endif

/*	$OpenBSD: src/usr.sbin/cron/atrun.c,v 1.14 2005/01/30 20:45:58 millert Exp $	*/
...
static const char rcsid[] = "$OpenBSD: src/usr.sbin/cron/atrun.c,v 1.14 2005/01/30 20:45:58 millert Exp $";
#endif

/*	$OpenBSD: src/usr.sbin/cron/atrun.c,v 1.11 2004/05/13 14:22:18 millert Exp $	*/
...
static const char rcsid[] = "$OpenBSD: src/usr.sbin/cron/atrun.c,v 1.11 2004/05/13 14:22:18 millert Exp $";
#endif

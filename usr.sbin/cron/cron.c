/*	$OpenBSD: src/usr.sbin/cron/cron.c,v 1.12 2001/02/20 02:03:19 millert Exp $	*/
...
static char rcsid[] = "$OpenBSD: src/usr.sbin/cron/cron.c,v 1.12 2001/02/20 02:03:19 millert Exp $";
#endif

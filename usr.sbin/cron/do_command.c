/*	$OpenBSD: src/usr.sbin/cron/do_command.c,v 1.12 2002/01/09 00:51:00 millert Exp $	*/
...
static char rcsid[] = "$OpenBSD: src/usr.sbin/cron/do_command.c,v 1.12 2002/01/09 00:51:00 millert Exp $";
#endif

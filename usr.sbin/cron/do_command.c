/*	$OpenBSD: src/usr.sbin/cron/do_command.c,v 1.32 2007/05/25 17:50:41 millert Exp $	*/
...
static char const rcsid[] = "$OpenBSD: src/usr.sbin/cron/do_command.c,v 1.32 2007/05/25 17:50:41 millert Exp $";
#endif

/*	$OpenBSD: src/usr.sbin/cron/do_command.c,v 1.20 2002/07/15 22:16:50 millert Exp $	*/
...
static char const rcsid[] = "$OpenBSD: src/usr.sbin/cron/do_command.c,v 1.20 2002/07/15 22:16:50 millert Exp $";
#endif

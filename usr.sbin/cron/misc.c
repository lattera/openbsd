/*	$OpenBSD: src/usr.sbin/cron/misc.c,v 1.28 2004/05/10 12:14:54 millert Exp $	*/
...
static char const rcsid[] = "$OpenBSD: src/usr.sbin/cron/misc.c,v 1.28 2004/05/10 12:14:54 millert Exp $";
#endif

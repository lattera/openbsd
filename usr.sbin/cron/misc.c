/*	$OpenBSD: src/usr.sbin/cron/misc.c,v 1.18 2002/05/28 01:20:19 deraadt Exp $	*/
...
static char rcsid[] = "$OpenBSD: src/usr.sbin/cron/misc.c,v 1.18 2002/05/28 01:20:19 deraadt Exp $";
#endif

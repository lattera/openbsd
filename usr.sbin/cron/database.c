/*	$OpenBSD: src/usr.sbin/cron/database.c,v 1.8 2002/08/02 22:40:48 millert Exp $	*/
...
static char const rcsid[] = "$OpenBSD: src/usr.sbin/cron/database.c,v 1.8 2002/08/02 22:40:48 millert Exp $";
#endif

/*	$OpenBSD: src/usr.sbin/cron/database.c,v 1.6 2002/05/09 21:22:01 millert Exp $	*/
...
static char rcsid[] = "$OpenBSD: src/usr.sbin/cron/database.c,v 1.6 2002/05/09 21:22:01 millert Exp $";
#endif

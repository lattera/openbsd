/*	$OpenBSD: src/usr.sbin/cron/database.c,v 1.9 2002/08/04 22:10:24 millert Exp $	*/
...
static char const rcsid[] = "$OpenBSD: src/usr.sbin/cron/database.c,v 1.9 2002/08/04 22:10:24 millert Exp $";
#endif

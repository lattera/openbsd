/*	$OpenBSD: src/usr.sbin/cron/database.c,v 1.16 2004/06/22 03:15:33 avsm Exp $	*/
...
static char const rcsid[] = "$OpenBSD: src/usr.sbin/cron/database.c,v 1.16 2004/06/22 03:15:33 avsm Exp $";
#endif

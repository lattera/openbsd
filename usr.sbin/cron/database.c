/*	$OpenBSD: src/usr.sbin/cron/database.c,v 1.14 2004/06/03 18:41:58 millert Exp $	*/
...
static char const rcsid[] = "$OpenBSD: src/usr.sbin/cron/database.c,v 1.14 2004/06/03 18:41:58 millert Exp $";
#endif

/*	$OpenBSD: src/usr.sbin/cron/database.c,v 1.17 2007/03/28 16:49:25 millert Exp $	*/
...
static char const rcsid[] = "$OpenBSD: src/usr.sbin/cron/database.c,v 1.17 2007/03/28 16:49:25 millert Exp $";
#endif

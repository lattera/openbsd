/*	$OpenBSD: src/usr.sbin/cron/database.c,v 1.7 2002/07/08 18:11:02 millert Exp $	*/
...
static char const rcsid[] = "$OpenBSD: src/usr.sbin/cron/database.c,v 1.7 2002/07/08 18:11:02 millert Exp $";
#endif

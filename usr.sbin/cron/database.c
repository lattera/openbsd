/*	$OpenBSD: src/usr.sbin/cron/database.c,v 1.15 2004/06/17 22:11:55 millert Exp $	*/
...
static char const rcsid[] = "$OpenBSD: src/usr.sbin/cron/database.c,v 1.15 2004/06/17 22:11:55 millert Exp $";
#endif

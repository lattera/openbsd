/*	$OpenBSD: src/usr.sbin/cron/database.c,v 1.11 2002/08/10 20:28:51 millert Exp $	*/
...
static char const rcsid[] = "$OpenBSD: src/usr.sbin/cron/database.c,v 1.11 2002/08/10 20:28:51 millert Exp $";
#endif

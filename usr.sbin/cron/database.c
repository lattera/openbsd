/*	$OpenBSD: src/usr.sbin/cron/database.c,v 1.13 2003/03/15 00:39:01 millert Exp $	*/
...
static char const rcsid[] = "$OpenBSD: src/usr.sbin/cron/database.c,v 1.13 2003/03/15 00:39:01 millert Exp $";
#endif

/*	$OpenBSD: src/usr.sbin/cron/entry.c,v 1.12 2002/07/11 20:15:40 millert Exp $	*/
/*
...
static char const rcsid[] = "$OpenBSD: src/usr.sbin/cron/entry.c,v 1.12 2002/07/11 20:15:40 millert Exp $";
#endif

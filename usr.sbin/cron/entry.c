/*	$OpenBSD: src/usr.sbin/cron/entry.c,v 1.9 2002/06/14 21:35:01 todd Exp $	*/
/*
...
static char rcsid[] = "$OpenBSD: src/usr.sbin/cron/entry.c,v 1.9 2002/06/14 21:35:01 todd Exp $";
#endif
